...
# 82 "./src/main/config/config_eeprom.c" 3 4
   __builtin_offsetof (
# 82 "./src/main/config/config_eeprom.c"
   packingTest_t
# 82 "./src/main/config/config_eeprom.c" 3 4
   , 
# 82 "./src/main/config/config_eeprom.c"
...
# 82 "./src/main/config/config_eeprom.c"
   != 0)]));
    ((void)sizeof(char[1 - 2*!!(
# 83 "./src/main/config/config_eeprom.c" 3 4
   __builtin_offsetof (
# 83 "./src/main/config/config_eeprom.c"
   packingTest_t
# 83 "./src/main/config/config_eeprom.c" 3 4
   , 
# 83 "./src/main/config/config_eeprom.c"
...
# 110 "./src/main/config/config_eeprom.c"
           loadPG(const configRecord_t *record)
{
    const pgRegistry_t *reg = pgMatcher(pgMatcherForConfigRecord, record);

    if (reg == 
# 114 "./src/main/config/config_eeprom.c" 3 4
              ((void *)0)
# 114 "./src/main/config/config_eeprom.c"
                  ) {
        return 
# 115 "./src/main/config/config_eeprom.c" 3 4
              0
# 115 "./src/main/config/config_eeprom.c"
                   ;
    }
    ...
    if (!pgIsSystem(reg)) {
        profileIndex = (record->flags & (0x3)) - 1;
    }

    pgLoad(reg, record->pg, record->size, profileIndex);
    return 
# 125 "./src/main/config/config_eeprom.c" 3 4
          1
# 125 "./src/main/config/config_eeprom.c"
              ;
}
...
# 130 "./src/main/config/config_eeprom.c" 3 4
_Bool 
# 130 "./src/main/config/config_eeprom.c"
    scanEEPROM(
# 130 "./src/main/config/config_eeprom.c" 3 4
               _Bool 
# 130 "./src/main/config/config_eeprom.c"
                    andLoad)
{
    ...
    if (header->format != EEPROM_CONF_VERSION) {
        return 
# 137 "./src/main/config/config_eeprom.c" 3 4
              0
# 137 "./src/main/config/config_eeprom.c"
                   ;
    }
    ...
    for (;;) {
        ...
        if (p + record->size >= &__config_end
            ...
            return 
# 152 "./src/main/config/config_eeprom.c" 3 4
                  0
# 152 "./src/main/config/config_eeprom.c"
                       ;
        }
...
# 170 "./src/main/config/config_eeprom.c" 3 4
_Bool 
# 170 "./src/main/config/config_eeprom.c"
    isEEPROMContentValid(void)
{
    return scanEEPROM(
# 172 "./src/main/config/config_eeprom.c" 3 4
                     0
# 172 "./src/main/config/config_eeprom.c"
                          );
}

static 
# 175 "./src/main/config/config_eeprom.c" 3 4
      _Bool 
# 175 "./src/main/config/config_eeprom.c"
...
# 233 "./src/main/config/config_eeprom.c" 3 4
   _Bool 
# 233 "./src/main/config/config_eeprom.c"
...
# 240 "./src/main/config/config_eeprom.c" 3 4
   _Bool 
# 240 "./src/main/config/config_eeprom.c"
        success = 
# 240 "./src/main/config/config_eeprom.c" 3 4
                  0
# 240 "./src/main/config/config_eeprom.c"
    ...
    for (int attempt = 0; attempt < 3 && !success; attempt++) {
        if (writeSettingsToEEPROM()) {
            success = 
# 244 "./src/main/config/config_eeprom.c" 3 4
                     1
# 244 "./src/main/config/config_eeprom.c"
                         ;
        }
    }
