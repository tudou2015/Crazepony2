...
# 26 "./src/main/config/config_streamer.h"
...
void config_streamer_start(config_streamer_t *c, uintptr_t base, int size)
{
    ...
    if (!c->unlocked) {
        FLASH_Unlock();
        c->unlocked = 
# 50 "./src/main/config/config_streamer.c" 3 4
                     1
# 50 "./src/main/config/config_streamer.c"
                         ;
    }
...
int config_streamer_finish(config_streamer_t *c)
{
    if (c->unlocked) {
        FLASH_Lock();
        c->unlocked = 
# 119 "./src/main/config/config_streamer.c" 3 4
                     0
# 119 "./src/main/config/config_streamer.c"
                          ;
    }
    return c->err;
}
