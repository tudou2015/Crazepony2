...
# 46 "./src/main/sensors/battery.c" 2
...
extern const batteryConfig_t pgResetTemplate_batteryConfig; batteryConfig_t batteryConfig_System; extern const pgRegistry_t batteryConfig_Registry; const pgRegistry_t batteryConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 11 | (0 << 12), .size = sizeof(batteryConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&batteryConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_batteryConfig}, };

const batteryConfig_t pgResetTemplate_batteryConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .vbatscale = 110, .vbatresdivval = 10, .vbatresdivmultiplier = 1, .vbatmaxcellvoltage = 43, .vbatmincellvoltage = 0, .vbatwarningcellvoltage = 31, .currentMeterScale = 400, .currentMeterType = CURRENT_SENSOR_ADC, }
# 85 "./src/main/sensors/battery.c"
 ;
...
static void updateBatteryVoltage(void)
{
    ...
    vbatSample = vbatLatestADC = adcGetChannel(ADC_CHANNEL0);
...
void updateBattery(void)
{
 ...
 flag.batt = vbat;
 static 
# 175 "./src/main/sensors/battery.c" 3 4
       _Bool 
# 175 "./src/main/sensors/battery.c"
            a;
 static uint32_t b,c;
 if((batteryState == BATTERY_WARNING) && (vbat > 20))
 {
  if(a) {b = millis(); a = 
# 179 "./src/main/sensors/battery.c" 3 4
                          0
# 179 "./src/main/sensors/battery.c"
                               ;}
  c = millis();
...
# 186 "./src/main/sensors/battery.c" 3 4
          1
# 186 "./src/main/sensors/battery.c"
              ;
...
void updateCurrentMeter(int32_t lastUpdateAt)
{
    ...
    amperageRaw += (amperageLatestADC = adcGetChannel(ADC_CHANNEL1));
