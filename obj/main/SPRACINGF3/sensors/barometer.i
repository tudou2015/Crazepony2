...
# 62 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 62 "./src/main/sensors/barometer.c"
    isBaroCalibrationComplete(void)
{
...
static 
# 72 "./src/main/sensors/barometer.c" 3 4
      _Bool 
# 72 "./src/main/sensors/barometer.c"
           baroReady = 
# 72 "./src/main/sensors/barometer.c" 3 4
                       0
# 72 "./src/main/sensors/barometer.c"
...
static int32_t applyBarometerMedianFilter(int32_t newPressureReading)
{
    ...
    static 
# 80 "./src/main/sensors/barometer.c" 3 4
          _Bool 
# 80 "./src/main/sensors/barometer.c"
               medianFilterReady = 
# 80 "./src/main/sensors/barometer.c" 3 4
                                   0
# 80 "./src/main/sensors/barometer.c"
    ...
    if (nextSampleIndex == 3) {
        nextSampleIndex = 0;
        medianFilterReady = 
# 86 "./src/main/sensors/barometer.c" 3 4
                           1
# 86 "./src/main/sensors/barometer.c"
                               ;
    }
...
static uint32_t recalculateBarometerTotal(uint8_t baroSampleCount, uint32_t pressureTotal, int32_t newPressureReading)
{
    ...
    if (nextSampleIndex == baroSampleCount) {
        nextSampleIndex = 0;
        baroReady = 
# 110 "./src/main/sensors/barometer.c" 3 4
                   1
# 110 "./src/main/sensors/barometer.c"
                       ;
    }
...
# 130 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 130 "./src/main/sensors/barometer.c"
    isBaroReady(void) {
 return baroReady;
}
