...
static 
# 57 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 57 "./src/main/sensors/gyro.c"
...
const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_lpf = 1, .soft_gyro_lpf_hz = 100, .gyroMovementCalibrationThreshold = 32, }
...
static void initGyroFilterCoefficients(void)
{
    if (gyroConfig()->soft_gyro_lpf_hz) {
        ...
        gyroFilterStateIsSet = 
# 80 "./src/main/sensors/gyro.c" 3 4
                              1
...
# 89 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 89 "./src/main/sensors/gyro.c"
    isGyroCalibrationComplete(void)
{
...
static 
# 94 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 94 "./src/main/sensors/gyro.c"
...
static 
# 99 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 99 "./src/main/sensors/gyro.c"
