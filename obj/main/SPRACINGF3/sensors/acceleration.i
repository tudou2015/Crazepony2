...
extern 
# 78 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 78 "./src/main/sensors/acceleration.c"
...
# 90 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 90 "./src/main/sensors/acceleration.c"
    isAccelerationCalibrationComplete(void)
{
...
void performInflightAccelerationCalibration(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    if (InflightcalibratingA > 0) {
        ...
        if (InflightcalibratingA == 1) {
            AccInflightCalibrationActive = 
# 166 "./src/main/sensors/acceleration.c" 3 4
                                          0
# 166 "./src/main/sensors/acceleration.c"
                                               ;
            AccInflightCalibrationMeasurementDone = 
# 167 "./src/main/sensors/acceleration.c" 3 4
                                                   1
# 167 "./src/main/sensors/acceleration.c"
                                                       ;
    ...
    if (AccInflightCalibrationSavetoEEProm) {
        AccInflightCalibrationSavetoEEProm = 
# 180 "./src/main/sensors/acceleration.c" 3 4
                                            0
# 180 "./src/main/sensors/acceleration.c"
                                                 ;
