...
# 11 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/string.h" 2 3
...
# 12 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/string.h" 2 3
...
# 13 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/string.h" 2 3
...
# 21 "./src/main/drivers/accgyro_adxl345.h" 3 4
   _Bool 
# 21 "./src/main/drivers/accgyro_adxl345.h"
        useFifo;
    uint16_t dataRate;
} drv_adxl345_config_t;


# 25 "./src/main/drivers/accgyro_adxl345.h" 3 4
_Bool 
# 25 "./src/main/drivers/accgyro_adxl345.h"
    adxl345Detect(drv_adxl345_config_t *init, acc_t *acc);
...
# 20 "./src/main/drivers/accgyro_bma280.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_bma280.h"
    bma280Detect(acc_t *acc);
...
# 20 "./src/main/drivers/accgyro_l3g4200d.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_l3g4200d.h"
    l3g4200dDetect(gyro_t *gyro);
...
# 20 "./src/main/drivers/accgyro_mma845x.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_mma845x.h"
    mma8452Detect(acc_t *acc);
...
# 20 "./src/main/drivers/accgyro_l3gd20.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_l3gd20.h"
    l3gd20Detect(gyro_t *gyro);
...
# 467 "./src/main/drivers/accgyro_lsm303dlhc.h" 3 4
_Bool 
# 467 "./src/main/drivers/accgyro_lsm303dlhc.h"
    lsm303dlhcAccDetect(acc_t *acc);
...
# 31 "./src/main/drivers/barometer_bmp085.h" 3 4
_Bool 
# 31 "./src/main/drivers/barometer_bmp085.h"
    bmp085Detect(const bmp085Config_t *config, baro_t *baro);
...
# 20 "./src/main/drivers/barometer_bmp280.h" 3 4
_Bool 
# 20 "./src/main/drivers/barometer_bmp280.h"
    bmp280Detect(baro_t *baro);
...
# 20 "./src/main/drivers/barometer_ms5611.h" 3 4
_Bool 
# 20 "./src/main/drivers/barometer_ms5611.h"
    ms5611Detect(baro_t *baro);
...
# 35 "./src/main/drivers/compass_hmc5883l.h" 3 4
_Bool 
# 35 "./src/main/drivers/compass_hmc5883l.h"
    hmc5883lDetect(mag_t* mag, const hmc5883Config_t *hmc5883ConfigToUse);
void hmc5883lInit(void);

# 37 "./src/main/drivers/compass_hmc5883l.h" 3 4
_Bool 
# 37 "./src/main/drivers/compass_hmc5883l.h"
    hmc5883lRead(int16_t *magData);
...
# 20 "./src/main/drivers/compass_ak8975.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass_ak8975.h"
    ak8975Detect(mag_t *mag);
void ak8975Init(void);

# 22 "./src/main/drivers/compass_ak8975.h" 3 4
_Bool 
# 22 "./src/main/drivers/compass_ak8975.h"
    ak8975Read(int16_t *magData);
...
# 20 "./src/main/drivers/compass_ak8963.h" 3 4
_Bool 
# 20 "./src/main/drivers/compass_ak8963.h"
    ak8963Detect(mag_t *mag);
void ak8963Init(void);

# 22 "./src/main/drivers/compass_ak8963.h" 3 4
_Bool 
# 22 "./src/main/drivers/compass_ak8963.h"
    ak8963Read(int16_t *magData);
...
# 172 "./src/main/sensors/initialisation.c"
    return 
# 172 "./src/main/sensors/initialisation.c" 3 4
          ((void *)0)
# 172 "./src/main/sensors/initialisation.c"
              ;
}
# 223 "./src/main/sensors/initialisation.c"

# 223 "./src/main/sensors/initialisation.c" 3 4
_Bool 
# 223 "./src/main/sensors/initialisation.c"
    detectGyro(void)
{
    ...
    switch(gyroHardware) {
        ...
        case GYRO_MPU6050:
            ...
            ;
        case GYRO_L3G4200D:
# 253 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_MPU3050:
# 265 "./src/main/sensors/initialisation.c"
            ;

        case GYRO_L3GD20:
# 277 "./src/main/sensors/initialisation.c"
            ;
...
# 289 "./src/main/sensors/initialisation.c"
        ...
        case GYRO_MPU6500:
# 312 "./src/main/sensors/initialisation.c"
            ;
    ...
    if (gyroHardware == GYRO_NONE) {
        return 
# 327 "./src/main/sensors/initialisation.c" 3 4
              0
# 327 "./src/main/sensors/initialisation.c"
                   ;
    }
    ...
    return 
# 333 "./src/main/sensors/initialisation.c" 3 4
          1
# 333 "./src/main/sensors/initialisation.c"
              ;
}
...
# 338 "./src/main/sensors/initialisation.c" 3 4
   _Bool 
# 338 "./src/main/sensors/initialisation.c"
        sensorDetected;
    (void)(sensorDetected);
...
retry:
    ...
    switch (accHardwareToUse) {
        case ACC_DEFAULT:
            ;
        case ACC_ADXL345:
# 370 "./src/main/sensors/initialisation.c"
            ;
        case ACC_LSM303DLHC:
# 381 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6050:
...
# 419 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6000:
# 430 "./src/main/sensors/initialisation.c"
            ;
        case ACC_MPU6500:
# 451 "./src/main/sensors/initialisation.c"
            ;
        case ACC_FAKE:
...
# 514 "./src/main/sensors/initialisation.c"
    switch (baroHardware) {
        case BARO_DEFAULT:
            ;
...
# 667 "./src/main/sensors/initialisation.c"
...
# 682 "./src/main/sensors/initialisation.c" 3 4
_Bool 
# 682 "./src/main/sensors/initialisation.c"
    sensorsAutodetect(void)
{
    ...
    if (!detectGyro()) {
        return 
# 696 "./src/main/sensors/initialisation.c" 3 4
              0
# 696 "./src/main/sensors/initialisation.c"
                   ;
    }
    ...
    return 
# 716 "./src/main/sensors/initialisation.c" 3 4
          1
# 716 "./src/main/sensors/initialisation.c"
              ;
}
