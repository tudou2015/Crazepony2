# 1 "./src/main/io/motor_and_servo.c"
...
# 1 "./src/main/io/motor_and_servo.c"
# 18 "./src/main/io/motor_and_servo.c"
...
# 19 "./src/main/io/motor_and_servo.c" 2
...
# 20 "./src/main/io/motor_and_servo.c" 2
...
# 21 "./src/main/io/motor_and_servo.c" 2
...
# 23 "./src/main/io/motor_and_servo.c" 2
...
# 25 "./src/main/io/motor_and_servo.c" 2
...
# 27 "./src/main/io/motor_and_servo.c" 2
...
# 28 "./src/main/io/motor_and_servo.c" 2
...
# 29 "./src/main/io/motor_and_servo.c" 2
...
# 31 "./src/main/io/motor_and_servo.c" 2
...
extern const motorAndServoConfig_t pgResetTemplate_motorAndServoConfig; motorAndServoConfig_t motorAndServoConfig_System; extern const pgRegistry_t motorAndServoConfig_Registry; const pgRegistry_t motorAndServoConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 6 | (0 << 12), .size = sizeof(motorAndServoConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&motorAndServoConfig_System, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_motorAndServoConfig}, };

const motorAndServoConfig_t pgResetTemplate_motorAndServoConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .minthrottle = 1050, .maxthrottle = 1950, .mincommand = 1000, .servoCenterPulse = 1500, .motor_pwm_rate = 16000, .servo_pwm_rate = 50, }
