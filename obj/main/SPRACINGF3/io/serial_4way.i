...
# 88 "./src/main/io/serial_4way.c" 3 4
_Bool 
# 88 "./src/main/io/serial_4way.c"
    esc4wayExitRequested = 
# 88 "./src/main/io/serial_4way.c" 3 4
                           0
# 88 "./src/main/io/serial_4way.c"
...
static 
# 92 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 92 "./src/main/io/serial_4way.c"
           isMcuConnected(void)
{
...
# 107 "./src/main/io/serial_4way.c" 3 4
_Bool 
# 107 "./src/main/io/serial_4way.c"
    isEscLo(uint8_t selEsc)
{
    return (digitalIn(escHardware[selEsc].gpio, escHardware[selEsc].pin) == Bit_RESET);
}
...
static 
# 261 "./src/main/io/serial_4way.c" 3 4
      _Bool 
# 261 "./src/main/io/serial_4way.c"
           signatureMatch(uint16_t signature, uint16_t *list)
{
    for(; *list; list++)
        if(signature == *list)
            return 
# 265 "./src/main/io/serial_4way.c" 3 4
                  1
# 265 "./src/main/io/serial_4way.c"
                      ;
    return 
# 266 "./src/main/io/serial_4way.c" 3 4
          0
# 266 "./src/main/io/serial_4way.c"
               ;
}
...
void esc4wayProcess(serialPort_t *serial)
{
    ...
    esc4wayExitRequested = 
# 348 "./src/main/io/serial_4way.c" 3 4
                          0
# 348 "./src/main/io/serial_4way.c"
                               ;
...
esc4wayAck_e esc4wayProcessCmd(esc4wayCmd_e command, uint16_t addr, uint8_t *data, int inLen, int *outLen)
{
    ...
    switch(command) {
        ...
        case cmd_InterfaceExit:
            esc4wayExitRequested = 
# 466 "./src/main/io/serial_4way.c" 3 4
                                  1
# 466 "./src/main/io/serial_4way.c"
                                      ;
            return esc4wayAck_OK;
