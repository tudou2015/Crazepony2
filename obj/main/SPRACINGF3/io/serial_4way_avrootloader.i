...
# 30 "./src/main/io/serial_4way_impl.h" 3 4
_Bool 
# 30 "./src/main/io/serial_4way_impl.h"
...
# 139 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                                    _Bool 
# 139 "./src/main/io/serial_4way_avrootloader.c"
                                                         checkCrc)
{
    int crc = 0;
    int c;
...
# 170 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                                 _Bool 
# 170 "./src/main/io/serial_4way_avrootloader.c"
                                                      appendCrc)
{
...
# 201 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                          0
# 201 "./src/main/io/serial_4way_avrootloader.c"
                                               );
    if (!BL_ReadBuf(bootInfo, sizeof(bootInfo), 
# 202 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                               0
# 202 "./src/main/io/serial_4way_avrootloader.c"
                                                    ))
        return 0;
...
# 226 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 226 "./src/main/io/serial_4way_avrootloader.c"
                                      );
    if (BL_GetACK(1) != 0xC1)
        return 0;
    return 1;
...
void BL_SendCMDRunRestartBootloader(void)
{
    uint8_t sCMD[] = {0, 0};
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 235 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 235 "./src/main/io/serial_4way_avrootloader.c"
                                      );
    return;
}
...
static uint8_t BL_SendCMDSetAddress(ioMem_t *pMem)
{
    ...
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 245 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 245 "./src/main/io/serial_4way_avrootloader.c"
                                      );
...
static uint8_t BL_SendCMDSetBuffer(ioMem_t *pMem)
{
    ...
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 253 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 253 "./src/main/io/serial_4way_avrootloader.c"
                                      );
    if (BL_GetACK(2) != 0xFF)
        return 0;
    BL_SendBuf(pMem->data, len, 
# 256 "./src/main/io/serial_4way_avrootloader.c" 3 4
                               1
# 256 "./src/main/io/serial_4way_avrootloader.c"
                                   );
...
static uint8_t BL_ReadA(uint8_t cmd, ioMem_t *pMem)
{
    ...
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 266 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 266 "./src/main/io/serial_4way_avrootloader.c"
                                      );
    return BL_ReadBuf(pMem->data, len, 
# 267 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                      1
# 267 "./src/main/io/serial_4way_avrootloader.c"
                                          );
}
...
static uint8_t BL_WriteA(uint8_t cmd, ioMem_t *pMem, uint32_t timeout)
{
    ...
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 277 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 277 "./src/main/io/serial_4way_avrootloader.c"
                                      );
...
uint8_t BL_PageErase(ioMem_t *pMem)
{
    ...
    BL_SendBuf(sCMD, sizeof(sCMD), 
# 304 "./src/main/io/serial_4way_avrootloader.c" 3 4
                                  1
# 304 "./src/main/io/serial_4way_avrootloader.c"
                                      );
