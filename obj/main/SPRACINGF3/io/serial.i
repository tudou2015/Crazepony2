...
static serialPortUsage_t *findSerialPortUsageByIdentifier(serialPortIdentifier_e identifier)
{
    ...
    return 
# 117 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 117 "./src/main/io/serial.c"
              ;
}
...
serialPortUsage_t *findSerialPortUsageByPort(serialPort_t *serialPort)
{
    ...
    return 
# 129 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 129 "./src/main/io/serial.c"
              ;
}
...
serialPortConfig_t *findNextSerialPortConfig(uint16_t mask)
{
    ...
    return 
# 154 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 154 "./src/main/io/serial.c"
              ;
}
...
# 169 "./src/main/io/serial.c" 3 4
_Bool 
# 169 "./src/main/io/serial.c"
    isSerialPortShared(serialPortConfig_t *portConfig, uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
...
# 174 "./src/main/io/serial.c" 3 4
_Bool 
# 174 "./src/main/io/serial.c"
    isSerialPortOpen(serialPortConfig_t *portConfig)
{
...
serialPort_t *findNextSharedSerialPort(uint16_t functionMask, serialPortFunction_e sharedWithFunction)
{
    ...
    return 
# 203 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 203 "./src/main/io/serial.c"
              ;
}
...
# 209 "./src/main/io/serial.c" 3 4
_Bool 
# 209 "./src/main/io/serial.c"
...
# 232 "./src/main/io/serial.c"
            ...
            if (!(portConfig->functionMask & FUNCTION_MSP_SERVER)) {
                return 
# 236 "./src/main/io/serial.c" 3 4
                      0
# 236 "./src/main/io/serial.c"
                           ;
            }
            ...
            if (!(portConfig->functionMask & (FUNCTION_BLACKBOX | (FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK)))) {
                ...
                return 
# 241 "./src/main/io/serial.c" 3 4
                      0
# 241 "./src/main/io/serial.c"
                           ;
            }
        }
    }
    ...
    if (mspPortCount == 0 || mspPortCount > 2) {
        return 
# 247 "./src/main/io/serial.c" 3 4
              0
# 247 "./src/main/io/serial.c"
                   ;
    }
    return 
# 249 "./src/main/io/serial.c" 3 4
          1
# 249 "./src/main/io/serial.c"
              ;
}
...
serialPortConfig_t *serialFindPortConfiguration(serialPortIdentifier_e identifier)
{
    ...
    return 
# 261 "./src/main/io/serial.c" 3 4
          ((void *)0)
# 261 "./src/main/io/serial.c"
              ;
}


# 264 "./src/main/io/serial.c" 3 4
_Bool 
# 264 "./src/main/io/serial.c"
    ...
    portOptions_t options)
{
    ...
    if (!serialPortUsage || serialPortUsage->function != FUNCTION_NONE) {
        ...
        return 
# 288 "./src/main/io/serial.c" 3 4
              ((void *)0)
# 288 "./src/main/io/serial.c"
                  ;
    }
...
# 325 "./src/main/io/serial.c"
    ...
    if (!serialPort) {
        return 
# 341 "./src/main/io/serial.c" 3 4
              ((void *)0)
# 341 "./src/main/io/serial.c"
                  ;
    }
...
void closeSerialPort(serialPort_t *serialPort)
{
    ...
    serialPort->callback = 
# 362 "./src/main/io/serial.c" 3 4
                          ((void *)0)
# 362 "./src/main/io/serial.c"
                              ;

    serialPortUsage->function = FUNCTION_NONE;
    serialPortUsage->serialPort = 
# 365 "./src/main/io/serial.c" 3 4
                                 ((void *)0)
# 365 "./src/main/io/serial.c"
                                     ;
}

void serialInit(
# 368 "./src/main/io/serial.c" 3 4
               _Bool 
# 368 "./src/main/io/serial.c"
                    softserialEnabled)
{
    uint8_t index;
...
# 409 "./src/main/io/serial.c" 3 4
_Bool 
# 409 "./src/main/io/serial.c"
    serialIsPortAvailable(serialPortIdentifier_e identifier)
{
    for (uint8_t index = 0; index < 5; index++) {
        if (serialPortUsageList[index].identifier == identifier) {
            return 
# 413 "./src/main/io/serial.c" 3 4
                  1
# 413 "./src/main/io/serial.c"
                      ;
        }
    }
    return 
