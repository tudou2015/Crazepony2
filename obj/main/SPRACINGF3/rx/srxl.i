...
static 
# 74 "./src/main/rx/srxl.c" 3 4
      _Bool 
# 74 "./src/main/rx/srxl.c"
           srxlFrameReceived = 
# 74 "./src/main/rx/srxl.c" 3 4
                               0
# 74 "./src/main/rx/srxl.c"
                                    ;
static 
# 75 "./src/main/rx/srxl.c" 3 4
      _Bool 
# 75 "./src/main/rx/srxl.c"
           srxlDataIncoming = 
# 75 "./src/main/rx/srxl.c" 3 4
                              0
# 75 "./src/main/rx/srxl.c"
...
# 87 "./src/main/rx/srxl.c" 3 4
_Bool 
# 87 "./src/main/rx/srxl.c"
    srxlInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    uint32_t baudRate;
    rxRuntimeConfig->channelCount = 16;
    srxlFrameReceived = 
# 91 "./src/main/rx/srxl.c" 3 4
                       0
# 91 "./src/main/rx/srxl.c"
                            ;
    srxlDataIncoming = 
# 92 "./src/main/rx/srxl.c" 3 4
                      0
# 92 "./src/main/rx/srxl.c"
                           ;
    srxlFramePosition = 0;
    baudRate = 115200;
    ...
    if (!portConfig) {
        return 
# 104 "./src/main/rx/srxl.c" 3 4
              0
# 104 "./src/main/rx/srxl.c"
                   ;
    }
    ...
    return srxlPort != 
# 109 "./src/main/rx/srxl.c" 3 4
                      ((void *)0)
# 109 "./src/main/rx/srxl.c"
                          ;
}
...
static void srxlDataReceive(uint16_t c)
{
    ...
    if (srxlTimeInterval > 8000) {
        srxlFramePosition = 0;
        srxlDataIncoming = 
# 125 "./src/main/rx/srxl.c" 3 4
                          0
# 125 "./src/main/rx/srxl.c"
                               ;
    }
    ...
    if (srxlFramePosition == 0) {
        if (c == (0xA1)) {
          srxlDataIncoming = 
# 131 "./src/main/rx/srxl.c" 3 4
                            1
# 131 "./src/main/rx/srxl.c"
                                ;
          ...
          srxlDataIncoming = 
# 136 "./src/main/rx/srxl.c" 3 4
                            1
# 136 "./src/main/rx/srxl.c"
                                ;
          srxlFrameLength = (16*2 + 3);
         srxlChannelCount = 16;
        }
    ...
    if (srxlDataIncoming == 
# 143 "./src/main/rx/srxl.c" 3 4
                           1
# 143 "./src/main/rx/srxl.c"
                               ) {
    ...
    if (srxlFramePosition == srxlFrameLength) {
        srxlFrameReceived = 
# 151 "./src/main/rx/srxl.c" 3 4
                           1
# 151 "./src/main/rx/srxl.c"
                               ;
        srxlDataIncoming = 
# 152 "./src/main/rx/srxl.c" 3 4
                          0
# 152 "./src/main/rx/srxl.c"
                               ;
        srxlFramePosition = 0;
    }
}
...
uint8_t srxlFrameStatus(void)
{
    ...
    srxlFrameReceived = 
# 169 "./src/main/rx/srxl.c" 3 4
                       0
# 169 "./src/main/rx/srxl.c"
                            ;
