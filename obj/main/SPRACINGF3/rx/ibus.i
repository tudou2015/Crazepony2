...
static 
# 50 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 50 "./src/main/rx/ibus.c"
           ibusFrameDone = 
# 50 "./src/main/rx/ibus.c" 3 4
                           0
# 50 "./src/main/rx/ibus.c"
...
# 56 "./src/main/rx/ibus.c" 3 4
_Bool 
# 56 "./src/main/rx/ibus.c"
    ibusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    if (callback)
...
# 65 "./src/main/rx/ibus.c"
    ...
    return ibusPort != 
# 70 "./src/main/rx/ibus.c" 3 4
                      ((void *)0)
# 70 "./src/main/rx/ibus.c"
                          ;
}
...
static void ibusDataReceive(uint16_t c)
{
    ...
    if (ibusFramePosition == 32 - 1) {
        ibusFrameDone = 
# 95 "./src/main/rx/ibus.c" 3 4
                       1
# 95 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
uint8_t ibusFrameStatus(void)
{
    ...
    ibusFrameDone = 
# 111 "./src/main/rx/ibus.c" 3 4
                   0
# 111 "./src/main/rx/ibus.c"
                        ;
