...
static 
# 60 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 60 "./src/main/rx/xbus.c"
           xBusFrameReceived = 
# 60 "./src/main/rx/xbus.c" 3 4
                               0
# 60 "./src/main/rx/xbus.c"
                                    ;
static 
# 61 "./src/main/rx/xbus.c" 3 4
      _Bool 
# 61 "./src/main/rx/xbus.c"
           xBusDataIncoming = 
# 61 "./src/main/rx/xbus.c" 3 4
                              0
# 61 "./src/main/rx/xbus.c"
...
# 74 "./src/main/rx/xbus.c" 3 4
_Bool 
# 74 "./src/main/rx/xbus.c"
    xBusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    uint32_t baudRate;
...
# 80 "./src/main/rx/xbus.c"
                            ;
    xBusDataIncoming = 
# 81 "./src/main/rx/xbus.c" 3 4
                      0
# 81 "./src/main/rx/xbus.c"
                           ;
    xBusFramePosition = 0;
    baudRate = 250000;
    xBusChannelCount = 12;
    ...
    if (!portConfig) {
        return 
# 94 "./src/main/rx/xbus.c" 3 4
              0
# 94 "./src/main/rx/xbus.c"
                   ;
    }
    ...
    return xBusPort != 
# 99 "./src/main/rx/xbus.c" 3 4
                      ((void *)0)
# 99 "./src/main/rx/xbus.c"
                          ;
}
...
# 206 "./src/main/rx/xbus.c"
    ...
    if (xBusFramePosition >= 33) {
        ...
        xBusFramePosition = 0;
        xBusDataIncoming = 
# 214 "./src/main/rx/xbus.c" 3 4
                          0
# 214 "./src/main/rx/xbus.c"
                               ;
    }
    ...
    if ((xBusFramePosition == 0) && (c == (0xA1))) {
        xBusDataIncoming = 
# 219 "./src/main/rx/xbus.c" 3 4
                          1
# 219 "./src/main/rx/xbus.c"
                              ;
    }


    if (xBusDataIncoming == 
# 223 "./src/main/rx/xbus.c" 3 4
                           1
# 223 "./src/main/rx/xbus.c"
                               ) {
    ...
    if (xBusFramePosition == xBusFrameLength) {
        xBusFrameReceived = 
# 239 "./src/main/rx/xbus.c" 3 4
                           1
# 239 "./src/main/rx/xbus.c"
                               ;
    }
}
