...
static 
# 38 "./src/main/rx/msp.c" 3 4
      _Bool 
# 38 "./src/main/rx/msp.c"
           rxMspFrameDone = 
# 38 "./src/main/rx/msp.c" 3 4
                            0
# 38 "./src/main/rx/msp.c"
...
void rxMspFrameReceive(uint16_t *frame, int channelCount)
{
    ...
    rxMspFrameDone = 
# 57 "./src/main/rx/msp.c" 3 4
                    1
# 57 "./src/main/rx/msp.c"
                        ;
}


# 60 "./src/main/rx/msp.c" 3 4
_Bool 
# 60 "./src/main/rx/msp.c"
    rxMspFrameComplete(void)
{
    if (!rxMspFrameDone) {
        return 
...
# 63 "./src/main/rx/msp.c"
    ...
    rxMspFrameDone = 
# 66 "./src/main/rx/msp.c" 3 4
                    0
# 66 "./src/main/rx/msp.c"
                         ;
    return 
# 67 "./src/main/rx/msp.c" 3 4
          1
# 67 "./src/main/rx/msp.c"
              ;
}
