...
# 21 "./src/main/rx/sbus.h" 3 4
_Bool 
# 21 "./src/main/rx/sbus.h"
    sbusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
# 21 "./src/main/rx/sumd.h" 3 4
_Bool 
# 21 "./src/main/rx/sumd.h"
    sumdInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
# 21 "./src/main/rx/sumh.h" 3 4
_Bool 
# 21 "./src/main/rx/sumh.h"
    sumhInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
# 22 "./src/main/rx/xbus.h" 3 4
_Bool 
# 22 "./src/main/rx/xbus.h"
    xBusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
# 21 "./src/main/rx/ibus.h" 3 4
_Bool 
# 21 "./src/main/rx/ibus.h"
    ibusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
# 70 "./src/main/rx/rx.c" 2
...
# 22 "./src/main/rx/srxl.h" 3 4
_Bool 
# 22 "./src/main/rx/srxl.h"
    srxlInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
uint8_t srxlFrameStatus(void);
# 71 "./src/main/rx/rx.c" 2
...
static 
# 165 "./src/main/rx/rx.c" 3 4
                  _Bool 
# 165 "./src/main/rx/rx.c"
...
static 
# 170 "./src/main/rx/rx.c" 3 4
                  _Bool 
# 170 "./src/main/rx/rx.c"
...
# 177 "./src/main/rx/rx.c" 3 4
                                                                    _Bool 
# 177 "./src/main/rx/rx.c"
                                                                         valid)
{
    if (channel < 4 && !valid) {
...
# 315 "./src/main/rx/rx.c" 3 4
_Bool 
# 315 "./src/main/rx/rx.c"
    rxIsReceivingSignal(void)
{
...
static 
# 324 "./src/main/rx/rx.c" 3 4
      _Bool 
# 324 "./src/main/rx/rx.c"
           isRxDataDriven(void)
{
...
static void resetRxSignalReceivedFlagIfNeeded(uint32_t currentTime)
{
    ...
    if (((int32_t)(currentTime - needRxSignalBefore) >= 0)) {
        rxSignalReceived = 
# 336 "./src/main/rx/rx.c" 3 4
                          0
# 336 "./src/main/rx/rx.c"
                               ;
        rxSignalReceivedNotDataDriven = 
...
void updateRx(uint32_t currentTime)
{
    ...
    if (isRxDataDriven()) {
        rxDataReceived = 
# 360 "./src/main/rx/rx.c" 3 4
                        0
# 360 "./src/main/rx/rx.c"
                             ;
    }
# 377 "./src/main/rx/rx.c"
    if (feature(FEATURE_RX_MSP)) {
...
# 381 "./src/main/rx/rx.c"
                                  ;
            rxIsInFailsafeMode = 
# 382 "./src/main/rx/rx.c" 3 4
                                0
# 382 "./src/main/rx/rx.c"
                                     ;
...
# 390 "./src/main/rx/rx.c"
    ...
    if (feature(FEATURE_RX_PARALLEL_PWM)) {
        if (isPWMDataBeingReceived()) {
            rxSignalReceivedNotDataDriven = 
# 398 "./src/main/rx/rx.c" 3 4
                                           1
# 398 "./src/main/rx/rx.c"
                                               ;
            rxIsInFailsafeModeNotDataDriven = 
...
static uint16_t calculateNonDataDrivenChannel(uint8_t chan, uint16_t sample)
{
    ...
    static 
# 414 "./src/main/rx/rx.c" 3 4
          _Bool 
# 414 "./src/main/rx/rx.c"
               rxSamplesCollected = 
# 414 "./src/main/rx/rx.c" 3 4
                                    0
# 414 "./src/main/rx/rx.c"
    ...
    if (!rxSamplesCollected) {
        ...
        rxSamplesCollected = 
# 426 "./src/main/rx/rx.c" 3 4
                            1
# 426 "./src/main/rx/rx.c"
                                ;
    }
...
# 512 "./src/main/rx/rx.c" 3 4
   _Bool 
# 512 "./src/main/rx/rx.c"
        useValueFromRx = 
# 512 "./src/main/rx/rx.c" 3 4
                         1
# 512 "./src/main/rx/rx.c"
...
# 513 "./src/main/rx/rx.c"
    ...
    if (!rxSignalReceived || rxIsInFailsafeMode) {
        useValueFromRx = 
# 521 "./src/main/rx/rx.c" 3 4
                        0
# 521 "./src/main/rx/rx.c"
                             ;
    }
...
# 536 "./src/main/rx/rx.c" 3 4
       _Bool 
# 536 "./src/main/rx/rx.c"
...
void calculateRxChannelsAndUpdateFailsafe(uint32_t currentTime)
{
 ...
 if(c > 60) {
  c = 0;
  if(APP_DATA_FLAG == 
# 604 "./src/main/rx/rx.c" 3 4
                     1
# 604 "./src/main/rx/rx.c"
                         ) {
   APP_DATA_FLAG = 
# 605 "./src/main/rx/rx.c" 3 4
                  0
# 605 "./src/main/rx/rx.c"
                       ;
   WIFI_DATA_OK = 
# 606 "./src/main/rx/rx.c" 3 4
                 1
# 606 "./src/main/rx/rx.c"
                     ;
  }
  else WIFI_DATA_OK = 
# 608 "./src/main/rx/rx.c" 3 4
                     0
# 608 "./src/main/rx/rx.c"
                          ;
 }

 if(nrf_rx() || WIFI_DATA_OK) flag.single_loss = 
# 611 "./src/main/rx/rx.c" 3 4
                                                0
# 611 "./src/main/rx/rx.c"
                                                     ;
  else flag.single_loss = 
# 612 "./src/main/rx/rx.c" 3 4
                         1
# 612 "./src/main/rx/rx.c"
                             ;
 ...
 if(flag.single_loss || (flag.batt_low==2)) {
  ...
  if(!flag.batt_low) {
   mspData.motor[1] = 1500;
   mspData.motor[0] = 1500;
   mspData.motor[2 ] = 1500;
  }
...
# 635 "./src/main/rx/rx.c" 3 4
                   0
# 635 "./src/main/rx/rx.c"
                        ;
 ...
 if(a > 10) {
  a = 10;
  if(mspData.motor[3] >= 1650)mspData.motor[3] = 1580;
   else if(mspData.motor[3] >= 1495)mspData.motor[3] = 1420;
    else mspData.motor[3] = 1400;
 }
