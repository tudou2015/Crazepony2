...
# 84 "./src/main/rx/sbus.c" 3 4
_Bool 
# 84 "./src/main/rx/sbus.c"
    sbusInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    int b;
    for (b = 0; b < 18; b++)
    ...
    if (!portConfig) {
        return 
# 95 "./src/main/rx/sbus.c" 3 4
              0
# 95 "./src/main/rx/sbus.c"
                   ;
    }
    ...
    return sBusPort != 
# 100 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 100 "./src/main/rx/sbus.c"
                          ;
}
...
static void sbusDataReceive(uint16_t c)
{
    ...
    if (sbusFramePosition < 25) {
        ...
        if (sbusFramePosition == 25) {
            ...
            sbusFrameDone = 
# 169 "./src/main/rx/sbus.c" 3 4
                           1
# 169 "./src/main/rx/sbus.c"
                               ;
            ...
            sbusFrameDone = 
# 174 "./src/main/rx/sbus.c" 3 4
                           0
# 174 "./src/main/rx/sbus.c"
                                ;
        }
    }
}
...
uint8_t sbusFrameStatus(void)
{
    ...
    sbusFrameDone = 
# 184 "./src/main/rx/sbus.c" 3 4
                   0
# 184 "./src/main/rx/sbus.c"
                        ;
