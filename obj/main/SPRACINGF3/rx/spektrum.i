...
static 
# 55 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 55 "./src/main/rx/spektrum.c"
           rcFrameComplete = 
# 55 "./src/main/rx/spektrum.c" 3 4
                             0
# 55 "./src/main/rx/spektrum.c"
    ...
    spektrumInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    switch (rxConfig()->serialrx_provider) {
        case SERIALRX_SPEKTRUM2048:
            ...
            spek_chan_mask = 0x07;
            spekHiRes = 
# 74 "./src/main/rx/spektrum.c" 3 4
                       1
# 74 "./src/main/rx/spektrum.c"
                           ;
        ...
        case SERIALRX_SPEKTRUM1024:
            ...
            spek_chan_mask = 0x03;
            spekHiRes = 
# 81 "./src/main/rx/spektrum.c" 3 4
                       0
# 81 "./src/main/rx/spektrum.c"
                            ;
...
# 91 "./src/main/rx/spektrum.c"
    ...
    return spektrumPort != 
# 96 "./src/main/rx/spektrum.c" 3 4
                          ((void *)0)
# 96 "./src/main/rx/spektrum.c"
                              ;
}
...
static void spektrumDataReceive(uint16_t c)
{
    ...
    if (spekFramePosition < 16) {
        ...
        if (spekFramePosition == 16) {
            rcFrameComplete = 
# 117 "./src/main/rx/spektrum.c" 3 4
                             1
# 117 "./src/main/rx/spektrum.c"
                                 ;
        } else {
            rcFrameComplete = 
...
uint8_t spektrumFrameStatus(void)
{
    ...
    rcFrameComplete = 
# 134 "./src/main/rx/spektrum.c" 3 4
                     0
# 134 "./src/main/rx/spektrum.c"
                          ;
