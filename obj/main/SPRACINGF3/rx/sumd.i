...
static 
# 48 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 48 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 48 "./src/main/rx/sumd.c" 3 4
                           0
# 48 "./src/main/rx/sumd.c"
    ...
    sumdInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    if (!portConfig) {
        return 
# 64 "./src/main/rx/sumd.c" 3 4
              0
# 64 "./src/main/rx/sumd.c"
                   ;
    }
    ...
    return sumdPort != 
# 69 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 69 "./src/main/rx/sumd.c"
                          ;
}
...
static void sumdDataReceive(uint16_t c)
{
    ...
    if (sumdIndex == 0) {
        ...
        {
            sumdFrameDone = 
# 108 "./src/main/rx/sumd.c" 3 4
                           0
# 108 "./src/main/rx/sumd.c"
                                ;
            crc = 0;
        }
    }
    ...
    if (sumdIndex < sumdChannelCount * 2 + 4)
        ...
        if (sumdIndex == sumdChannelCount * 2 + 5) {
            sumdIndex = 0;
            sumdFrameDone = 
# 122 "./src/main/rx/sumd.c" 3 4
                           1
# 122 "./src/main/rx/sumd.c"
                               ;
        }
}
...
uint8_t sumdFrameStatus(void)
{
    ...
    sumdFrameDone = 
# 144 "./src/main/rx/sumd.c" 3 4
                   0
# 144 "./src/main/rx/sumd.c"
                        ;
