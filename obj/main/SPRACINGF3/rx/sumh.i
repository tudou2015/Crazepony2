...
# 67 "./src/main/rx/sumh.c" 3 4
_Bool 
# 67 "./src/main/rx/sumh.c"
    sumhInit(rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 78 "./src/main/rx/sumh.c" 3 4
              0
# 78 "./src/main/rx/sumh.c"
                   ;
    }
    ...
    return sumhPort != 
# 83 "./src/main/rx/sumh.c" 3 4
                      ((void *)0)
# 83 "./src/main/rx/sumh.c"
                          ;
}
...
static void sumhDataReceive(uint16_t c)
{
    ...
    if (sumhFramePosition == 21 - 1) {
        ...
        sumhFrameDone = 
# 103 "./src/main/rx/sumh.c" 3 4
                       1
# 103 "./src/main/rx/sumh.c"
                           ;
    } else {
        sumhFramePosition++;
    }
...
uint8_t sumhFrameStatus(void)
{
    ...
    sumhFrameDone = 
# 117 "./src/main/rx/sumh.c" 3 4
                   0
# 117 "./src/main/rx/sumh.c"
                        ;
