...
const pidProfile_t pgResetTemplate_pidProfile __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .pidController = PID_CONTROLLER_MWREWRITE, .P8[PIDROLL] = 66, .I8[PIDROLL] = 44, .D8[PIDROLL] = 27, .P8[PIDPITCH] = 66, .I8[PIDPITCH] = 42, .D8[PIDPITCH] = 28, .P8[PIDYAW] = 85, .I8[PIDYAW] = 45, .D8[PIDYAW] = 0, .P8[PIDALT] = 30, .I8[PIDALT] = 0, .D8[PIDALT] = 0, .P8[PIDPOS] = 15, .I8[PIDPOS] = 0, .D8[PIDPOS] = 0, .P8[PIDPOSR] = 34, .I8[PIDPOSR] = 14, .D8[PIDPOSR] = 53, .P8[PIDNAVR] = 25, .I8[PIDNAVR] = 33, .D8[PIDNAVR] = 83, .P8[PIDLEVEL] = 10, .I8[PIDLEVEL] = 10, .D8[PIDLEVEL] = 100, .P8[PIDMAG] = 40, .P8[PIDVEL] = 90, .I8[PIDVEL] = 45, .D8[PIDVEL] = 1, .yaw_p_limit = 500, .dterm_lpf = 100, .yaw_lpf = 80, .deltaMethod = PID_DELTA_FROM_MEASUREMENT, }
# 112 "./src/main/flight/pid.c"
 ;
