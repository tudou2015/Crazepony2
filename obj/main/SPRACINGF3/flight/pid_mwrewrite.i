# 1 "./src/main/flight/pid_mwrewrite.c"
...
# 1 "./src/main/flight/pid_mwrewrite.c"
# 18 "./src/main/flight/pid_mwrewrite.c"
...
# 21 "./src/main/flight/pid_mwrewrite.c" 2
...
# 22 "./src/main/flight/pid_mwrewrite.c" 2
...
# 23 "./src/main/flight/pid_mwrewrite.c" 2
...
# 24 "./src/main/flight/pid_mwrewrite.c" 2
...
# 26 "./src/main/flight/pid_mwrewrite.c" 2
...
# 28 "./src/main/flight/pid_mwrewrite.c" 2
...
# 30 "./src/main/flight/pid_mwrewrite.c" 2
...
# 31 "./src/main/flight/pid_mwrewrite.c" 2
...
# 32 "./src/main/flight/pid_mwrewrite.c" 2
...
# 34 "./src/main/flight/pid_mwrewrite.c" 2
...
# 36 "./src/main/flight/pid_mwrewrite.c" 2
...
# 37 "./src/main/flight/pid_mwrewrite.c" 2
...
# 38 "./src/main/flight/pid_mwrewrite.c" 2
...
# 40 "./src/main/flight/pid_mwrewrite.c" 2
...
# 41 "./src/main/flight/pid_mwrewrite.c" 2
...
# 42 "./src/main/flight/pid_mwrewrite.c" 2
...
# 44 "./src/main/flight/pid_mwrewrite.c" 2
...
# 46 "./src/main/flight/pid_mwrewrite.c" 2
...
# 47 "./src/main/flight/pid_mwrewrite.c" 2
...
void mwDisarm(void);
# 48 "./src/main/flight/pid_mwrewrite.c" 2
...
# 52 "./src/main/flight/pid_mwrewrite.c" 2
...
# 53 "./src/main/flight/pid_mwrewrite.c" 2
# 1 "./src/main/flight/gtune.h" 1
# 18 "./src/main/flight/gtune.h"
       
# 54 "./src/main/flight/pid_mwrewrite.c" 2
...
# 55 "./src/main/flight/pid_mwrewrite.c" 2
...
static int16_t pidMultiWiiRewriteCore(int axis, const pidProfile_t *pidProfile, int32_t gyroRate, int32_t angleRate)
{
    ...
    ITerm = constrain(ITerm, (int32_t)(-256 << 13), (int32_t)(256 << 13));
    ...
    if (rcModeIsActive(BOXAIRMODE)) {
        if ((stateFlags & (ANTI_WINDUP)) || motorLimitReached) {
            ...
            ITermLimit[axis] = ((ITerm) > 0 ? (ITerm) : -(ITerm));
        }
    }
        ...
        uint16_t max_angle_inclination, const rollAndPitchTrims_t *angleTrim, const rxConfig_t *rxConfig)
{
    ...
    if ((flightModeFlags & (HORIZON_MODE))) {
        ...
        const int32_t stickPosAil = ((getRcStickDeflection(ROLL, rxConfig->midrc)) > 0 ? (getRcStickDeflection(ROLL, rxConfig->midrc)) : -(getRcStickDeflection(ROLL, rxConfig->midrc)));
        const int32_t stickPosEle = ((getRcStickDeflection(PITCH, rxConfig->midrc)) > 0 ? (getRcStickDeflection(PITCH, rxConfig->midrc)) : -(getRcStickDeflection(PITCH, rxConfig->midrc)));
