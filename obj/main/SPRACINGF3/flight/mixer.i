...
# 71 "./src/main/flight/mixer.c" 3 4
_Bool 
# 71 "./src/main/flight/mixer.c"
    motorLimitReached;
...
const motor3DConfig_t pgResetTemplate_motor3DConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .deadband3d_low = 1406, .deadband3d_high = 1514, .neutral3d = 1460, }
 ...
 ;
# 97 "./src/main/flight/mixer.c"
const mixerConfig_t pgResetTemplate_mixerConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mixerMode = MIXER_QUADX, .pid_at_min_throttle = 1, .yaw_motor_direction = 1, .yaw_jump_prevention_limit = 200, }




 ;
# 112 "./src/main/flight/mixer.c"
...
const mixer_t mixers[] = {
    ...
    { 0, 
# 273 "./src/main/flight/mixer.c" 3 4
        0
# 273 "./src/main/flight/mixer.c"
             , 
# 273 "./src/main/flight/mixer.c" 3 4
               ((void *)0) 
# 273 "./src/main/flight/mixer.c"
    ...
    { 3, 
# 274 "./src/main/flight/mixer.c" 3 4
        1
# 274 "./src/main/flight/mixer.c"
            , mixerTricopter },
    { 4, 
# 275 "./src/main/flight/mixer.c" 3 4
        0
# 275 "./src/main/flight/mixer.c"
             , mixerQuadP },
    { 4, 
# 276 "./src/main/flight/mixer.c" 3 4
        0
# 276 "./src/main/flight/mixer.c"
             , mixerQuadX },
    { 2, 
# 277 "./src/main/flight/mixer.c" 3 4
        1
# 277 "./src/main/flight/mixer.c"
            , mixerBicopter },
    { 0, 
...
# 316 "./src/main/flight/mixer.c"
    ...
    { 3, 
# 317 "./src/main/flight/mixer.c" 3 4
        1
# 317 "./src/main/flight/mixer.c"
            , 
# 317 "./src/main/flight/mixer.c" 3 4
               ((void *)0) 
# 317 "./src/main/flight/mixer.c"
...
# 414 "./src/main/flight/mixer.c" 3 4
   _Bool 
# 414 "./src/main/flight/mixer.c"
        isFailsafeActive = failsafeIsActive();
    ...
    if (rcModeIsActive(BOXAIRMODE)) {
        ...
        if (rollPitchYawMixRange > throttleRange) {
            motorLimitReached = 
# 472 "./src/main/flight/mixer.c" 3 4
                               1
# 472 "./src/main/flight/mixer.c"
                                   ;
            ...
            motorLimitReached = 
# 480 "./src/main/flight/mixer.c" 3 4
                               0
# 480 "./src/main/flight/mixer.c"
                                    ;
