...
# 55 "./src/main/flight/altitudehold.c" 2
...
# 57 "./src/main/flight/altitudehold.c" 2
...
# 60 "./src/main/flight/altitudehold.c" 2
...
# 64 "./src/main/flight/altitudehold.c" 2
...
# 96 "./src/main/flight/altitudehold.c" 3 4
                                                   0
# 96 "./src/main/flight/altitudehold.c"
                                                        ) {
...
void updateAltHoldState(void)
{
 ...
 }else disableFlightMode(BARO_MODE);
# 251 "./src/main/flight/altitudehold.c"
}
...
# 271 "./src/main/flight/altitudehold.c" 3 4
_Bool 
# 271 "./src/main/flight/altitudehold.c"
...
void calculateEstimatedAltitude(uint32_t currentTime)
{
 ...
 BaroAlt = FB.Altitude;
# 386 "./src/main/flight/altitudehold.c"
    dt = accTimeSum * 1e-6f;
    ...
    vel += vel_acc;
# 408 "./src/main/flight/altitudehold.c"
 flag.height = accAlt;
 debug[0] = accAlt;
 ...
 if(!FB.calibrate_finished)
  return;
# 432 "./src/main/flight/altitudehold.c"
    EstAlt = accAlt;
