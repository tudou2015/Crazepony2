...
# 19 "./src/main/flight/pid_mw23.c" 2
...
# 20 "./src/main/flight/pid_mw23.c" 2
...
# 21 "./src/main/flight/pid_mw23.c" 2
...
# 22 "./src/main/flight/pid_mw23.c" 2
...
# 24 "./src/main/flight/pid_mw23.c" 2
...
# 26 "./src/main/flight/pid_mw23.c" 2
...
# 30 "./src/main/flight/pid_mw23.c" 2
...
# 31 "./src/main/flight/pid_mw23.c" 2
...
# 32 "./src/main/flight/pid_mw23.c" 2
...
# 37 "./src/main/flight/pid_mw23.c" 2
...
# 38 "./src/main/flight/pid_mw23.c" 2
...
# 39 "./src/main/flight/pid_mw23.c" 2
...
# 41 "./src/main/flight/pid_mw23.c" 2
...
# 42 "./src/main/flight/pid_mw23.c" 2
...
# 43 "./src/main/flight/pid_mw23.c" 2
...
# 45 "./src/main/flight/pid_mw23.c" 2
...
# 47 "./src/main/flight/pid_mw23.c" 2
...
# 48 "./src/main/flight/pid_mw23.c" 2
...
void mwDisarm(void);
# 49 "./src/main/flight/pid_mw23.c" 2
...
# 51 "./src/main/flight/pid_mw23.c" 2
...
# 52 "./src/main/flight/pid_mw23.c" 2
...
# 53 "./src/main/flight/pid_mw23.c" 2
# 1 "./src/main/flight/gtune.h" 1
# 18 "./src/main/flight/gtune.h"
       
# 54 "./src/main/flight/pid_mw23.c" 2
...
# 55 "./src/main/flight/pid_mw23.c" 2
        ...
        uint16_t max_angle_inclination, const rollAndPitchTrims_t *angleTrim, const rxConfig_t *rxConfig)
{
    ...
    for (axis = 0; axis < 2; axis++) {
        ...
        error = rc - gyroError;
        lastITerm[axis] = constrain(lastITerm[axis] + error, -16000, +16000);
        ...
        if (rcModeIsActive(BOXAIRMODE)) {
            if ((stateFlags & (ANTI_WINDUP)) || motorLimitReached) {
                ...
                ITermLimit[axis] = ((lastITerm[axis]) > 0 ? (lastITerm[axis]) : -(lastITerm[axis]));
            }
        }

        ITerm = (lastITerm[axis] >> 7) * pidProfile->I8[axis] >> 6;
        ...
        if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
            ...
            ITermAngle[axis] = constrain(ITermAngle[axis] + errorAngle, -10000, +10000);
            ...
            ITermACC = ((int32_t)ITermAngle[axis] * pidProfile->I8[PIDLEVEL]) >> 12;
        ...
        if (pidProfile->dterm_lpf) {
            ...
            DTerm = delta;
            DTerm = lrintf(pt1FilterApply4(&deltaFilter[axis], (float)DTerm, pidProfile->dterm_lpf, dT)) * 3;
        } else {
...
# 173 "./src/main/flight/pid_mw23.c"
    }
    ...
    if (((rc) > 0 ? (rc) : -(rc)) > 50) lastITerm[FD_YAW] = 0;
    ...
    ITerm = constrain((int16_t)(lastITerm[FD_YAW] >> 13), -256, +256);

    axisPID[FD_YAW] = PTerm + ITerm;
# 208 "./src/main/flight/pid_mw23.c"
}
