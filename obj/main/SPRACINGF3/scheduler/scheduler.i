...
# 66 "./src/main/scheduler/scheduler.c"
static 
# 66 "./src/main/scheduler/scheduler.c" 3 4
                  _Bool 
# 66 "./src/main/scheduler/scheduler.c"
                       queueContains(cfTask_t *task)
{
    for (unsigned int ii = 0; ii < taskQueueSize; ++ii) {
        if (taskQueueArray[ii] == task) {
            return 
# 70 "./src/main/scheduler/scheduler.c" 3 4
                  1
# 70 "./src/main/scheduler/scheduler.c"
                      ;
        }
    }
    return 
...
# 82 "./src/main/scheduler/scheduler.c"
            ...
            ++taskQueueSize;
            return 
# 86 "./src/main/scheduler/scheduler.c" 3 4
                  1
# 86 "./src/main/scheduler/scheduler.c"
                      ;
        }
    }
    return 
                       ...
                       queueRemove(cfTask_t *task)
{
    for (unsigned int ii = 0; ii < taskQueueSize; ++ii) {
        if (taskQueueArray[ii] == task) {
            ...
            --taskQueueSize;
            return 
# 98 "./src/main/scheduler/scheduler.c" 3 4
                  1
# 98 "./src/main/scheduler/scheduler.c"
                      ;
        }
    }
    return 
...
# 132 "./src/main/scheduler/scheduler.c" 3 4
                                                     ((void *)0)
# 132 "./src/main/scheduler/scheduler.c"
                                                         ; task = queueNext()) {
...
void setTaskEnabled(const int taskId, 
# 166 "./src/main/scheduler/scheduler.c" 3 4
                                     _Bool 
# 166 "./src/main/scheduler/scheduler.c"
                                          enabled)
{
    if (taskId == -1 || taskId < (int)taskCount) {
        cfTask_t *task = taskId == -1 ? currentTask : &cfTasks[taskId];
...
# 199 "./src/main/scheduler/scheduler.c"
                                               ;
    for (const cfTask_t *task = queueFirst(); task != 
# 200 "./src/main/scheduler/scheduler.c" 3 4
                                                     ((void *)0) 
# 200 "./src/main/scheduler/scheduler.c"
    ...
    const 
# 209 "./src/main/scheduler/scheduler.c" 3 4
         _Bool 
# 209 "./src/main/scheduler/scheduler.c"
              outsideRealtimeGuardInterval = (timeToNextRealtimeTask > realtimeGuardInterval);


    cfTask_t *selectedTask = 
# 212 "./src/main/scheduler/scheduler.c" 3 4
                            ((void *)0)
# 212 "./src/main/scheduler/scheduler.c"
                                ;
...
# 217 "./src/main/scheduler/scheduler.c" 3 4
                                               ((void *)0)
# 217 "./src/main/scheduler/scheduler.c"
                                                   ; task = queueNext()) {

        if (task->checkFunc != 
# 219 "./src/main/scheduler/scheduler.c" 3 4
                              ((void *)0)
# 219 "./src/main/scheduler/scheduler.c"
                                  ) {
