    ...
    while ((ch = *(fmt++))) {
        if (ch != '%') {
            ...
            case 'u':{
                    ...
                    if (lng)
                        uli2a(
# 116 "./src/main/common/printf.c" 3 4
                             __builtin_va_arg(
# 116 "./src/main/common/printf.c"
                             va
# 116 "./src/main/common/printf.c" 3 4
                             ,
# 116 "./src/main/common/printf.c"
...
# 116 "./src/main/common/printf.c"
                        ...
                        ui2a(
# 119 "./src/main/common/printf.c" 3 4
                            __builtin_va_arg(
# 119 "./src/main/common/printf.c"
                            va
# 119 "./src/main/common/printf.c" 3 4
                            ,
# 119 "./src/main/common/printf.c"
...
# 119 "./src/main/common/printf.c"
            ...
            case 'd':{
                    ...
                    if (lng)
                        li2a(
# 126 "./src/main/common/printf.c" 3 4
                            __builtin_va_arg(
# 126 "./src/main/common/printf.c"
                            va
# 126 "./src/main/common/printf.c" 3 4
                            ,
# 126 "./src/main/common/printf.c"
...
# 126 "./src/main/common/printf.c"
                        ...
                        i2a(
# 129 "./src/main/common/printf.c" 3 4
                           __builtin_va_arg(
# 129 "./src/main/common/printf.c"
                           va
# 129 "./src/main/common/printf.c" 3 4
                           ,
# 129 "./src/main/common/printf.c"
...
# 129 "./src/main/common/printf.c"
            ...
            case 'X':
                ...
                if (lng)
                    uli2a(
# 137 "./src/main/common/printf.c" 3 4
                         __builtin_va_arg(
# 137 "./src/main/common/printf.c"
                         va
# 137 "./src/main/common/printf.c" 3 4
                         ,
# 137 "./src/main/common/printf.c"
...
# 137 "./src/main/common/printf.c"
                    ...
                    ui2a(
# 140 "./src/main/common/printf.c" 3 4
                        __builtin_va_arg(
# 140 "./src/main/common/printf.c"
                        va
# 140 "./src/main/common/printf.c" 3 4
                        ,
# 140 "./src/main/common/printf.c"
...
# 140 "./src/main/common/printf.c"
            ...
            case 'c':
                putf(putp, (char) (
# 144 "./src/main/common/printf.c" 3 4
                                  __builtin_va_arg(
# 144 "./src/main/common/printf.c"
                                  va
# 144 "./src/main/common/printf.c" 3 4
                                  ,
# 144 "./src/main/common/printf.c"
...
# 147 "./src/main/common/printf.c" 3 4
                                                   __builtin_va_arg(
# 147 "./src/main/common/printf.c"
                                                   va
# 147 "./src/main/common/printf.c" 3 4
                                                   ,
# 147 "./src/main/common/printf.c"
...
# 147 "./src/main/common/printf.c"
            ...
            case 'n':
                *
# 153 "./src/main/common/printf.c" 3 4
                __builtin_va_arg(
# 153 "./src/main/common/printf.c"
                va
# 153 "./src/main/common/printf.c" 3 4
                ,
# 153 "./src/main/common/printf.c"
...
# 175 "./src/main/common/printf.c" 3 4
   __builtin_va_end(
# 175 "./src/main/common/printf.c"
   va
# 175 "./src/main/common/printf.c" 3 4
   )
# 175 "./src/main/common/printf.c"
...
# 189 "./src/main/common/printf.c" 3 4
   __builtin_va_start(
# 189 "./src/main/common/printf.c"
   va
# 189 "./src/main/common/printf.c" 3 4
   ,
# 189 "./src/main/common/printf.c"
...
# 192 "./src/main/common/printf.c" 3 4
   __builtin_va_end(
# 192 "./src/main/common/printf.c"
   va
# 192 "./src/main/common/printf.c" 3 4
   )
# 192 "./src/main/common/printf.c"
...
{
    init_printf(
# 205 "./src/main/common/printf.c" 3 4
               ((void *)0)
# 205 "./src/main/common/printf.c"
                   , _putc);
}
