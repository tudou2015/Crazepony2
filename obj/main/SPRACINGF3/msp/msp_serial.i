...
static mspPort_t* mspPortFindFree(void)
{
    for(int i = 0; i < 2; i++)
        if(mspPorts[i].port == 
# 60 "./src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 60 "./src/main/msp/msp_serial.c"
                                  )
            return &mspPorts[i];
    return 
...
void mspSerialAllocatePorts(void)
{
    for(serialPortConfig_t *portConfig = findSerialPortConfig(FUNCTION_MSP_SERVER | FUNCTION_MSP_CLIENT);
        portConfig != 
# 68 "./src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 68 "./src/main/msp/msp_serial.c"
                         ;
        ...
        if(mspPort == 
# 75 "./src/main/msp/msp_serial.c" 3 4
                     ((void *)0)
# 75 "./src/main/msp/msp_serial.c"
                         ) {
...
# 94 "./src/main/msp/msp_serial.c"
        serialPort_t *serialPort = openSerialPort(portConfig->identifier, function, 
# 94 "./src/main/msp/msp_serial.c" 3 4
                                                                                   ((void *)0)
# 94 "./src/main/msp/msp_serial.c"
                                                                                       ,
...
# 111 "./src/main/msp/msp_serial.c" 3 4
                                 ((void *)0)
# 111 "./src/main/msp/msp_serial.c"
                                     );
        }
    }
}
...
# 119 "./src/main/msp/msp_serial.c" 3 4
                                  ((void *)0)
# 119 "./src/main/msp/msp_serial.c"
                                      );
    }
...
static 
# 211 "./src/main/msp/msp_serial.c" 3 4
      _Bool 
# 211 "./src/main/msp/msp_serial.c"
...
# 217 "./src/main/msp/msp_serial.c"
    ...
    return 
# 268 "./src/main/msp/msp_serial.c" 3 4
          1
# 268 "./src/main/msp/msp_serial.c"
              ;
}
...
# 282 "./src/main/msp/msp_serial.c" 3 4
           _Bool 
# 282 "./src/main/msp/msp_serial.c"
        ...
        if (mspPostProcessFn) {
            ...
            mspPostProcessFn = 
# 302 "./src/main/msp/msp_serial.c" 3 4
                              ((void *)0)
# 302 "./src/main/msp/msp_serial.c"
                                  ;
        }
...
# 322 "./src/main/msp/msp_serial.c" 3 4
           _Bool 
# 322 "./src/main/msp/msp_serial.c"
