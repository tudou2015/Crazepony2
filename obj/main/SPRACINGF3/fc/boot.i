...
# 35 "./src/main/drivers/serial_softserial.h"
    isSoftSerialTransmitBufferEmpty(serialPort_t *s);
...
# 47 "./src/main/drivers/serial_uart.h" 3 4
   _Bool 
# 47 "./src/main/drivers/serial_uart.h"
        txDMAEmpty;
...
# 68 "./src/main/drivers/serial_uart.h"
    isUartTransmitBufferEmpty(serialPort_t *s);
# 50 "./src/main/fc/boot.c" 2
...
# 67 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 67 "./src/main/drivers/pwm_mapping.h"
        useUART3;
...
# 75 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 75 "./src/main/drivers/pwm_mapping.h"
        useVbat;
    
# 76 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 76 "./src/main/drivers/pwm_mapping.h"
        useOneshot;
    
# 77 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 77 "./src/main/drivers/pwm_mapping.h"
        useSoftSerial;
...
# 78 "./src/main/drivers/pwm_mapping.h"
        useLEDStrip;
# 88 "./src/main/drivers/pwm_mapping.h"
    
# 88 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 88 "./src/main/drivers/pwm_mapping.h"
        airplane;
...
# 994 "./src/main/drivers/io_def_generated.h"
...
# 77 "./src/main/drivers/io.h" 3 4
_Bool 
# 77 "./src/main/drivers/io.h"
    IORead(IO_t io);
void IOWrite(IO_t io, 
# 78 "./src/main/drivers/io.h" 3 4
                     _Bool 
# 78 "./src/main/drivers/io.h"
                          value);
void IOHi(IO_t io);
void IOLo(IO_t io);
...
# 42 "./src/main/drivers/transponder_ir.h" 3 4
_Bool 
# 42 "./src/main/drivers/transponder_ir.h"
...
# 50 "./src/main/drivers/exti.h" 3 4
                        _Bool 
# 50 "./src/main/drivers/exti.h"
                             enable);
...
void init(void)
{
    ...
    EXTIInit();
# 289 "./src/main/fc/boot.c"
    ledInit(
# 289 "./src/main/fc/boot.c" 3 4
           0
# 289 "./src/main/fc/boot.c"
                );
# 325 "./src/main/fc/boot.c"
...
# 368 "./src/main/fc/boot.c"
    if (mixerConfig()->mixerMode == MIXER_AIRPLANE || mixerConfig()->mixerMode == MIXER_FLYING_WING || mixerConfig()->mixerMode == MIXER_CUSTOM_AIRPLANE)
        pwm_params.airplane = 
# 369 "./src/main/fc/boot.c" 3 4
                             1
# 369 "./src/main/fc/boot.c"
                                 ;
    else
        pwm_params.airplane = 
# 371 "./src/main/fc/boot.c" 3 4
                             0
# 371 "./src/main/fc/boot.c"
                                  ;
    ...
    pwm_params.useLEDStrip = 
# 392 "./src/main/fc/boot.c" 3 4
                            1
# 392 "./src/main/fc/boot.c"
                                ;
    pwm_params.usePPM = feature(FEATURE_RX_PPM);
    pwm_params.useSerialRx = feature(FEATURE_RX_SERIAL);
# 406 "./src/main/fc/boot.c"
    ...
    if (!feature(FEATURE_ONESHOT125))
        motorControlEnable = 
# 427 "./src/main/fc/boot.c" 3 4
                            1
# 427 "./src/main/fc/boot.c"
                                ;
    ...
    spiInit(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003C00)));
# 489 "./src/main/fc/boot.c"
    i2cInit((I2CDEV_1));
    ...
    adc_params.channelMask = (feature(FEATURE_VBAT) ? (1 << ADC_CHANNEL0) : 0);


    adc_params.channelMask |= (feature(FEATURE_RSSI_ADC) ? (1 << ADC_CHANNEL2) : 0);


    adc_params.channelMask |= (feature(FEATURE_CURRENT_METER) ? (1 << ADC_CHANNEL1) : 0);
# 526 "./src/main/fc/boot.c"
    adcInit(&adc_params);
...
# 667 "./src/main/fc/boot.c"
    if (feature(FEATURE_VBAT | FEATURE_CURRENT_METER))
        batteryInit();
# 682 "./src/main/fc/boot.c"
    latchActiveFeatures();
    motorControlEnable = 
# 683 "./src/main/fc/boot.c" 3 4
                        1
# 683 "./src/main/fc/boot.c"
                            ;

    systemState |= SYSTEM_STATE_READY;
}
# 699 "./src/main/fc/boot.c"
...
# 705 "./src/main/fc/boot.c" 3 4
                               1
# 705 "./src/main/fc/boot.c"
                                   );
    setTaskEnabled(TASK_GYROPID, 
# 706 "./src/main/fc/boot.c" 3 4
                                1
# 706 "./src/main/fc/boot.c"
                                    );
    rescheduleTask(TASK_GYROPID, imuConfig()->gyroSync ? targetLooptime - 10 : targetLooptime);
    setTaskEnabled(TASK_ACCEL, sensors(SENSOR_ACC));
    setTaskEnabled(TASK_SERIAL, 
# 709 "./src/main/fc/boot.c" 3 4
                               1
# 709 "./src/main/fc/boot.c"
                                   );
...
# 714 "./src/main/fc/boot.c" 3 4
                           1
# 714 "./src/main/fc/boot.c"
                               );
# 726 "./src/main/fc/boot.c"
 ...
 if(FB.calibrate_finished) setTaskEnabled(TASK_ALTITUDE, 
# 734 "./src/main/fc/boot.c" 3 4
                                                        1
# 734 "./src/main/fc/boot.c"
                                                            );
# 748 "./src/main/fc/boot.c"
 setTaskEnabled(TASK_LEDFLASH,
# 748 "./src/main/fc/boot.c" 3 4
                             1
# 748 "./src/main/fc/boot.c"
                                 );
 ...
 setTaskEnabled(TASK_FBM320, 
# 752 "./src/main/fc/boot.c" 3 4
                            1
# 752 "./src/main/fc/boot.c"
                                );
...
int main(void) {
 ...
 configureScheduler();
    ...
    while (
# 778 "./src/main/fc/boot.c" 3 4
          1
# 778 "./src/main/fc/boot.c"
              )
 {
