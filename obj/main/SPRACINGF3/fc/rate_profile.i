...
{
    for (int i = 0; i < 3; i++) {
        static const controlRateConfig_t _reset_template_51 = { .rcRate8 = 109, .rcExpo8 = 65, .thrMid8 = 52, .thrExpo8 = 40, .tpa_breakpoint = 1500, }; memcpy((&instance[i]), &_reset_template_51, sizeof(*(&instance[i])));
