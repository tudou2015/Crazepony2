...
const rcControlsConfig_t pgResetTemplate_rcControlsConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .deadband = 5, .yaw_deadband = 20, .alt_hold_deadband = 40, .alt_hold_fast_change = 1, .yaw_control_direction = 1, .deadband3d_throttle = 50, }
...
# 100 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 100 "./src/main/fc/rc_controls.c"
    areSticksInApModePosition(uint16_t ap_mode)
{
...
void processRcStickPositions(rxConfig_t *rxConfig, throttleStatus_e throttleStatus, 
# 124 "./src/main/fc/rc_controls.c" 3 4
                                                                                   _Bool 
# 124 "./src/main/fc/rc_controls.c"
                                                                                        retarded_arm, 
# 124 "./src/main/fc/rc_controls.c" 3 4
                                                                                                      _Bool 
# 124 "./src/main/fc/rc_controls.c"
...
# 278 "./src/main/fc/rc_controls.c" 3 4
   _Bool 
# 278 "./src/main/fc/rc_controls.c"
...
# 278 "./src/main/fc/rc_controls.c"
    ...
    if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (2 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        ...
        shouldApplyRollAndPitchTrimDelta = 
# 281 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 281 "./src/main/fc/rc_controls.c"
                                              ;
...
# 284 "./src/main/fc/rc_controls.c"
        ...
        shouldApplyRollAndPitchTrimDelta = 
# 287 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 287 "./src/main/fc/rc_controls.c"
                                              ;
    } else if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (3 << (2 * PITCH)) + (1 << (2 * ROLL))) {
        accelerometerTrimsDelta.values.roll = -2;
        shouldApplyRollAndPitchTrimDelta = 
# 290 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 290 "./src/main/fc/rc_controls.c"
                                              ;
    }
...
# 308 "./src/main/fc/rc_controls.c"
}


# 310 "./src/main/fc/rc_controls.c" 3 4
_Bool 
    ...
    rcModeIsActivationConditionPresent(modeActivationCondition_t *modeActivationConditions, boxId_e modeId)
{
    ...
    for (index = 0; index < 20; index++) {
        ...
        if (modeActivationCondition->modeId == modeId && ((&modeActivationCondition->range)->startStep < (&modeActivationCondition->range)->endStep)) {
            return 
# 318 "./src/main/fc/rc_controls.c" 3 4
                  1
# 318 "./src/main/fc/rc_controls.c"
                      ;
        }
    }
    return 
# 321 "./src/main/fc/rc_controls.c" 3 4
          0
# 321 "./src/main/fc/rc_controls.c"
               ;
}


# 324 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 324 "./src/main/fc/rc_controls.c"
    isRangeActive(uint8_t auxChannelIndex, channelRange_t *range)
{
    if (!((range)->startStep < (range)->endStep)) {
        return 
# 327 "./src/main/fc/rc_controls.c" 3 4
              0
# 327 "./src/main/fc/rc_controls.c"
                   ;
    }
...
# 335 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 335 "./src/main/fc/rc_controls.c"
    rcModeIsActive(boxId_e modeId)
{
