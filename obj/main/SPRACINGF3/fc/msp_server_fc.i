...
extern 
# 133 "./src/main/io/serial_4way.h" 3 4
      _Bool 
# 133 "./src/main/io/serial_4way.h"
           esc4wayExitRequested;
...
static const box_t *findBoxByBoxId(uint8_t boxId)
{
    ...
    return 
# 225 "./src/main/fc/msp_server_fc.c" 3 4
          ((void *)0)
...
static const box_t *findBoxByPermenantId(uint8_t permanentId)
{
    ...
    return 
# 236 "./src/main/fc/msp_server_fc.c" 3 4
          ((void *)0)
# 236 "./src/main/fc/msp_server_fc.c"
              ;
}
...
static void initActiveBoxIds(void)
{
    ...
    if (feature(FEATURE_SERVO_TILT))
        ena |= 1 << BOXCAMSTAB;
# 297 "./src/main/fc/msp_server_fc.c"
...
# 338 "./src/main/fc/msp_server_fc.c"
...
# 349 "./src/main/fc/msp_server_fc.c" 3 4
                                      ((void *)0)
# 349 "./src/main/fc/msp_server_fc.c"
                                          )
            ena &= ~ (1 << boxId);
    activeBoxIds = ena;
}
...
{
    sbuf_t *dst = &reply->buf;
# 447 "./src/main/fc/msp_server_fc.c"
    sbufWriteU8(dst, 0);
    sbufWriteU8(dst, 0);
    sbufWriteU8(dst, 0);
    sbufWriteU32(dst, 0);
...
{
    sbuf_t *dst = &reply->buf;
# 467 "./src/main/fc/msp_server_fc.c"
    sbufWriteU8(dst, 0);
    sbufWriteU32(dst, 0);
    sbufWriteU32(dst, 0);
    sbufWriteU32(dst, 0);
...
# 487 "./src/main/fc/msp_server_fc.c"
int mspServerCommandHandler(mspPacket_t *cmd, mspPacket_t *reply)
{
    sbuf_t *dst = &reply->buf;
    sbuf_t *src = &cmd->buf;
...
# 595 "./src/main/fc/msp_server_fc.c"
        case 104:
        ...
        case 115:
            ...
            for (int i = 0; i < 8; i++)
                sbufWriteU8(dst, i + 1);
            break;
# 793 "./src/main/fc/msp_server_fc.c"
        case 254:
        ...
        case 54:
            ...
            break;
# 937 "./src/main/fc/msp_server_fc.c"
        case 70:
            serializeDataflashSummaryReply(reply);
            break;
# 950 "./src/main/fc/msp_server_fc.c"
        case 80:
        ...
        case 35: {
            ...
            if (box == 
# 1070 "./src/main/fc/msp_server_fc.c" 3 4
                      ((void *)0)
# 1070 "./src/main/fc/msp_server_fc.c"
                          )
                return -1;
        ...
        case 207: {
            ...
            batteryConfig()->vbatscale = sbufReadU8(src);
        ...
        case 212: {
# 1176 "./src/main/fc/msp_server_fc.c"
            break;
        }

        case 242: {
# 1194 "./src/main/fc/msp_server_fc.c"
            break;
        }
        ...
        case 250:
            ...
            readEEPROM();
            break;
# 1312 "./src/main/fc/msp_server_fc.c"
        case 37:
            featureClearAll();
...
# 1470 "./src/main/fc/msp_server_fc.c"
        case 68:
