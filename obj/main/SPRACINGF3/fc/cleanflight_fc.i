...
# 216 "/opt/gcc-arm-none-eabi-5_4-2016q3/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 3 4
...
#undef __EXP
# 8 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/machine/_types.h" 2 3
...
# 36 "./src/main/fc/cleanflight_fc.c" 2
...
# 57 "./src/main/fc/cleanflight_fc.c" 2
...
# 59 "./src/main/fc/cleanflight_fc.c" 2
...
# 69 "./src/main/fc/cleanflight_fc.c" 2
...
# 80 "./src/main/fc/cleanflight_fc.c" 2
...
# 83 "./src/main/fc/cleanflight_fc.c" 2
...
# 86 "./src/main/fc/cleanflight_fc.c" 2
...
# 25 "./src/main/flight/altitudehold.h" 2
...
# 89 "./src/main/fc/cleanflight_fc.c" 2
...
# 116 "./src/main/fc/cleanflight_fc.c" 3 4
                            0
# 116 "./src/main/fc/cleanflight_fc.c"
                                 ;
...
static 
# 125 "./src/main/fc/cleanflight_fc.c" 3 4
      _Bool 
# 125 "./src/main/fc/cleanflight_fc.c"
           isRXDataNew;
...
# 163 "./src/main/fc/cleanflight_fc.c"

# 163 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 163 "./src/main/fc/cleanflight_fc.c"
    isCalibrating(void)
{
    ...
    if (sensors(SENSOR_BARO) && !isBaroCalibrationComplete()) {
        return 
# 167 "./src/main/fc/cleanflight_fc.c" 3 4
              1
# 167 "./src/main/fc/cleanflight_fc.c"
                  ;
    }
...
void releaseSharedTelemetryPorts(void) {
    serialPort_t *sharedPort = findSharedSerialPort((FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK), FUNCTION_MSP_SERVER);
     while (sharedPort) {
         mspSerialReleasePortIfAllocated(sharedPort);
         sharedPort = findNextSharedSerialPort((FUNCTION_TELEMETRY_FRSKY | FUNCTION_TELEMETRY_HOTT | FUNCTION_TELEMETRY_SMARTPORT | FUNCTION_TELEMETRY_LTM | FUNCTION_TELEMETRY_MAVLINK), FUNCTION_MSP_SERVER);
     }
}
...
# 350 "./src/main/fc/cleanflight_fc.c"
            disarmAt = millis() + armingConfig()->auto_disarm_delay * 1000;
# 359 "./src/main/fc/cleanflight_fc.c"
...
# 372 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 372 "./src/main/fc/cleanflight_fc.c"
...
# 373 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 373 "./src/main/fc/cleanflight_fc.c"
...
# 374 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 374 "./src/main/fc/cleanflight_fc.c"
...
# 375 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 375 "./src/main/fc/cleanflight_fc.c"
...
void handleInflightCalibrationStickPosition(void)
{
    if (AccInflightCalibrationMeasurementDone) {
        ...
        AccInflightCalibrationMeasurementDone = 
# 382 "./src/main/fc/cleanflight_fc.c" 3 4
                                               0
# 382 "./src/main/fc/cleanflight_fc.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 383 "./src/main/fc/cleanflight_fc.c" 3 4
                                            1
# 383 "./src/main/fc/cleanflight_fc.c"
                                                ;
    } else {
...
void updateInflightCalibrationState(void)
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !rcModeIsActive(BOXARM)) {
        ...
        AccInflightCalibrationArmed = 
# 398 "./src/main/fc/cleanflight_fc.c" 3 4
                                     0
# 398 "./src/main/fc/cleanflight_fc.c"
                                          ;
    }
    if (rcModeIsActive(BOXCALIB)) {
        if (!AccInflightCalibrationActive && !AccInflightCalibrationMeasurementDone)
            InflightcalibratingA = 50;
        AccInflightCalibrationActive = 
# 403 "./src/main/fc/cleanflight_fc.c" 3 4
                                      1
# 403 "./src/main/fc/cleanflight_fc.c"
                                          ;
    } else if (AccInflightCalibrationMeasurementDone && !(armingFlags & (ARMED))) {
        AccInflightCalibrationMeasurementDone = 
# 405 "./src/main/fc/cleanflight_fc.c" 3 4
                                               0
# 405 "./src/main/fc/cleanflight_fc.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 406 "./src/main/fc/cleanflight_fc.c" 3 4
                                            1
# 406 "./src/main/fc/cleanflight_fc.c"
                                                ;
    }
}
...
{
    static 
# 427 "./src/main/fc/cleanflight_fc.c" 3 4
          _Bool 
# 427 "./src/main/fc/cleanflight_fc.c"
               armedBeeperOn = 
# 427 "./src/main/fc/cleanflight_fc.c" 3 4
                               0
# 427 "./src/main/fc/cleanflight_fc.c"
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    mwDisarm();
                    armedBeeperOn = 
# 485 "./src/main/fc/cleanflight_fc.c" 3 4
                                   0
# 485 "./src/main/fc/cleanflight_fc.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 489 "./src/main/fc/cleanflight_fc.c" 3 4
                                   1
# 489 "./src/main/fc/cleanflight_fc.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 500 "./src/main/fc/cleanflight_fc.c" 3 4
                                   0
# 500 "./src/main/fc/cleanflight_fc.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 507 "./src/main/fc/cleanflight_fc.c" 3 4
                               1
# 507 "./src/main/fc/cleanflight_fc.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 510 "./src/main/fc/cleanflight_fc.c" 3 4
                               0
# 510 "./src/main/fc/cleanflight_fc.c"
                                    ;
            }
        }
    }
...
# 529 "./src/main/fc/cleanflight_fc.c" 3 4
   _Bool 
# 529 "./src/main/fc/cleanflight_fc.c"
        canUseHorizonMode = 
# 529 "./src/main/fc/cleanflight_fc.c" 3 4
                            1
# 529 "./src/main/fc/cleanflight_fc.c"
 ...
 if((rcModeIsActive(BOXANGLE) || (feature(FEATURE_FAILSAFE) && failsafeIsActive())) && (sensors(SENSOR_ACC)))
 {
        ...
        canUseHorizonMode = 
# 535 "./src/main/fc/cleanflight_fc.c" 3 4
                           0
# 535 "./src/main/fc/cleanflight_fc.c"
                                ;
    ...
    else {disableFlightMode(ANGLE_MODE);}
...
# 598 "./src/main/fc/cleanflight_fc.c"
...
# 621 "./src/main/fc/cleanflight_fc.c"
}
...
void filterRc(void){
    ...
    if (isRXDataNew) {
        ...
        isRXDataNew = 
# 640 "./src/main/fc/cleanflight_fc.c" 3 4
                     0
# 640 "./src/main/fc/cleanflight_fc.c"
                          ;
...
static 
# 657 "./src/main/fc/cleanflight_fc.c" 3 4
      _Bool 
# 657 "./src/main/fc/cleanflight_fc.c"
           haveUpdatedRcCommandsOnce = 
# 657 "./src/main/fc/cleanflight_fc.c" 3 4
                                       0
# 657 "./src/main/fc/cleanflight_fc.c"
                                            ;
...
void taskMainPidLoop(void)
{
    ...
    haveUpdatedRcCommandsOnce = 
# 682 "./src/main/fc/cleanflight_fc.c" 3 4
                               1
# 682 "./src/main/fc/cleanflight_fc.c"
                                   ;
...
# 702 "./src/main/fc/cleanflight_fc.c"
  {
            if ((flightModeFlags & (BARO_MODE)) || (flightModeFlags & (SONAR_MODE))) {
                applyAltHold();
            }
        }
# 715 "./src/main/fc/cleanflight_fc.c"
...
# 740 "./src/main/fc/cleanflight_fc.c"
    pid_controller(
        pidProfile(),
...
# 769 "./src/main/fc/cleanflight_fc.c"
}
...
void taskMainPidLoopChecker(void) {
    ...
    uint32_t currentDeltaTime = getTaskDeltaTime(-1);
...
# 813 "./src/main/fc/cleanflight_fc.c"
void taskUpdateBattery(void)
{
...
# 847 "./src/main/fc/cleanflight_fc.c" 3 4
_Bool 
# 847 "./src/main/fc/cleanflight_fc.c"
    taskUpdateRxCheck(uint32_t currentDeltaTime)
{
...
void taskUpdateRxMain(void)
{
    ...
    isRXDataNew = 
# 859 "./src/main/fc/cleanflight_fc.c" 3 4
                 1
# 859 "./src/main/fc/cleanflight_fc.c"
                     ;
...
# 880 "./src/main/fc/cleanflight_fc.c"
}
# 908 "./src/main/fc/cleanflight_fc.c"
void taskUpdateBaro(void)
{
...
# 927 "./src/main/fc/cleanflight_fc.c"
void taskCalculateAltitude(void)
{
# 942 "./src/main/fc/cleanflight_fc.c"
