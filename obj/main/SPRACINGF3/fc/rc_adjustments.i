...
void blackboxLogInflightAdjustmentEvent(adjustmentFunction_e adjustmentFunction, int32_t newValue)
{
    ...
    (void)(newValue);
# 73 "./src/main/fc/rc_adjustments.c"
}
...
void blackboxLogInflightAdjustmentEventFloat(adjustmentFunction_e adjustmentFunction, float newFloatValue)
{
    ...
    (void)(adjustmentFunction);
    (void)(newFloatValue);
# 89 "./src/main/fc/rc_adjustments.c"
}
...
void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta)
{
    ...
    switch(adjustmentFunction) {
        ...
        case ADJUSTMENT_YAW_P:
                setAdjustment(&pidProfile()->P8[PIDYAW],ADJUSTMENT_YAW_P,delta,0,200);
            break;
        case ADJUSTMENT_YAW_I:
            setAdjustment(&pidProfile()->I8[PIDYAW],ADJUSTMENT_YAW_I,delta,0,200);
            break;
        case ADJUSTMENT_YAW_D:
                setAdjustment(&pidProfile()->D8[PIDYAW],ADJUSTMENT_YAW_D,delta,0,200);
            break;
        case ADJUSTMENT_LEVEL_P:
            setAdjustment(&pidProfile()->P8[PIDLEVEL],ADJUSTMENT_LEVEL_P,delta,0,200);
            break;
        case ADJUSTMENT_LEVEL_I:
            setAdjustment(&pidProfile()->I8[PIDLEVEL],ADJUSTMENT_LEVEL_I,delta,0,200);
            break;
        case ADJUSTMENT_LEVEL_D:
            setAdjustment(&pidProfile()->D8[PIDLEVEL],ADJUSTMENT_LEVEL_D,delta,0,200);
            break;
        case ADJUSTMENT_ALT_P:
            setAdjustment(&pidProfile()->P8[PIDALT],ADJUSTMENT_ALT_P,delta,0,200);
            break;
        case ADJUSTMENT_ALT_I:
            setAdjustment(&pidProfile()->I8[PIDALT],ADJUSTMENT_ALT_I,delta,0,200);
            break;
        case ADJUSTMENT_ALT_D:
            setAdjustment(&pidProfile()->D8[PIDALT],ADJUSTMENT_ALT_D,delta,0,200);
            break;
        case ADJUSTMENT_POS_P:
            setAdjustment(&pidProfile()->P8[PIDPOS],ADJUSTMENT_POS_P,delta,0,200);
            break;
        case ADJUSTMENT_POS_I:
            setAdjustment(&pidProfile()->I8[PIDPOS],ADJUSTMENT_POS_I,delta,0,200);
            break;
        case ADJUSTMENT_POSR_P:
            setAdjustment(&pidProfile()->P8[PIDPOSR],ADJUSTMENT_POSR_P,delta,0,200);
            break;
        case ADJUSTMENT_POSR_I:
            setAdjustment(&pidProfile()->I8[PIDPOSR],ADJUSTMENT_POSR_I,delta,0,200);
            break;
        case ADJUSTMENT_POSR_D:
            setAdjustment(&pidProfile()->D8[PIDPOSR],ADJUSTMENT_POSR_D,delta,0,200);
            break;
       case ADJUSTMENT_NAVR_P:
            setAdjustment(&pidProfile()->P8[PIDNAVR],ADJUSTMENT_NAVR_P,delta,0,200);
            break;
        case ADJUSTMENT_NAVR_I:
            setAdjustment(&pidProfile()->I8[PIDNAVR],ADJUSTMENT_NAVR_I,delta,0,200);
            break;
        case ADJUSTMENT_NAVR_D:
            setAdjustment(&pidProfile()->D8[PIDNAVR],ADJUSTMENT_NAVR_D,delta,0,200);
            break;
        case ADJUSTMENT_MAG_P:
            setAdjustment(&pidProfile()->P8[PIDMAG],ADJUSTMENT_MAG_P,delta,0,200);
            break;
        case ADJUSTMENT_VEL_P:
            setAdjustment(&pidProfile()->P8[PIDVEL],ADJUSTMENT_VEL_P,delta,0,200);
            break;
        case ADJUSTMENT_VEL_I:
            setAdjustment(&pidProfile()->I8[PIDVEL],ADJUSTMENT_VEL_I,delta,0,200);
            break;
        case ADJUSTMENT_VEL_D:
            setAdjustment(&pidProfile()->D8[PIDVEL],ADJUSTMENT_VEL_D,delta,0,200);
            break;
        default:
            break;
    };
...
# 259 "./src/main/fc/rc_adjustments.c" 3 4
   _Bool 
# 259 "./src/main/fc/rc_adjustments.c"
        applied = 
# 259 "./src/main/fc/rc_adjustments.c" 3 4
                  0
# 259 "./src/main/fc/rc_adjustments.c"
    ...
    switch(adjustmentFunction) {
        case ADJUSTMENT_RATE_PROFILE:
            if (getCurrentControlRateProfile() != position) {
                ...
                applied = 
# 266 "./src/main/fc/rc_adjustments.c" 3 4
                         1
# 266 "./src/main/fc/rc_adjustments.c"
                             ;
            }
            break;
    }
...
# 283 "./src/main/fc/rc_adjustments.c" 3 4
   _Bool 
# 283 "./src/main/fc/rc_adjustments.c"
...
# 295 "./src/main/fc/rc_adjustments.c" 3 4
       _Bool 
# 295 "./src/main/fc/rc_adjustments.c"
