...
# 75 "./src/main/drivers/app.c" 2


uint8_t App_data[5];

# 78 "./src/main/drivers/app.c" 3 4
_Bool 
# 78 "./src/main/drivers/app.c"
    APP_DATA_FLAG = 
# 78 "./src/main/drivers/app.c" 3 4
                    0
# 78 "./src/main/drivers/app.c"
...
void wifi_uart_init(void)
{
 ...
 uartOpen(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x00004400)),App_DataReceive,19200,MODE_RX,SERIAL_NOT_INVERTED);
}


void App_DataReceive(uint16_t data)
{
 static uint8_t count, i, buffer[5 +1];
 ...
 switch(count)
 {
  ...
  case 2:if(buffer[5] == ((buffer[0]^buffer[1]^buffer[2]^buffer[3]^buffer[4])&0xff)) {
     memcpy(App_data,buffer,5);
     APP_DATA_FLAG = 
# 105 "./src/main/drivers/app.c" 3 4
                    1
# 105 "./src/main/drivers/app.c"
                        ;
    }
    count = 0;
    break;
