...
static 
# 122 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 122 "./src/main/drivers/serial_softserial.c"
...
static void serialTimerTxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference, uint32_t baud)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &softSerialPorts[reference].timerCb, 
...
static void serialTimerRxConfig(const timerHardware_t *timerHardwarePtr, uint8_t reference, portOptions_t options)
{
    ...
    timerChConfigCallbacks(timerHardwarePtr, &softSerialPorts[reference].edgeCb, 
# 168 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                ((void *)0)
# 168 "./src/main/drivers/serial_softserial.c"
                                                                                    );
}
...
# 215 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 215 "./src/main/drivers/serial_softserial.c"
                                         ;

    softSerial->isSearchingForStartBit = 
# 217 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 217 "./src/main/drivers/serial_softserial.c"
                                            ;
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 258 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 258 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 272 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 272 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 296 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 296 "./src/main/drivers/serial_softserial.c"
                                            ;
...
{
    (void)(capture);
    softSerial_t *softSerial = ( __extension__ ({ const typeof( ((softSerial_t *)0)->timerCb ) *__mptr = (cbRec); (softSerial_t *)( (char *)__mptr - 
# 361 "./src/main/drivers/serial_softserial.c" 3 4
                              __builtin_offsetof (
# 361 "./src/main/drivers/serial_softserial.c"
                              softSerial_t
# 361 "./src/main/drivers/serial_softserial.c" 3 4
                              , 
# 361 "./src/main/drivers/serial_softserial.c"
...
void onSerialRxPinChange(timerCCHandlerRec_t *cbRec, captureCompare_t capture)
{
    ...
    softSerial_t *softSerial = ( __extension__ ({ const typeof( ((softSerial_t *)0)->edgeCb ) *__mptr = (cbRec); (softSerial_t *)( (char *)__mptr - 
# 371 "./src/main/drivers/serial_softserial.c" 3 4
                              __builtin_offsetof (
# 371 "./src/main/drivers/serial_softserial.c"
                              softSerial_t
# 371 "./src/main/drivers/serial_softserial.c" 3 4
                              , 
# 371 "./src/main/drivers/serial_softserial.c"
...
# 372 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 372 "./src/main/drivers/serial_softserial.c"
        inverted = softSerial->port.options & SERIAL_INVERTED;
    ...
    if (softSerial->isSearchingForStartBit) {
        ...
        softSerial->isSearchingForStartBit = 
# 393 "./src/main/drivers/serial_softserial.c" 3 4
                                            0
# 393 "./src/main/drivers/serial_softserial.c"
                                                 ;
        return;
    }
...
# 474 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 474 "./src/main/drivers/serial_softserial.c"
    isSoftSerialTransmitBufferEmpty(serialPort_t *instance)
{
