...
extern adc_config_t adcConfig[3];
...
void adcInit(drv_adc_config_t *init)
{
    ...
    if (init->channelMask & ADC_CHANNEL0_ENABLE) {
        ...
        adcConfig[ADC_CHANNEL0].adcChannel = ((uint8_t)0x01);
        adcConfig[ADC_CHANNEL0].dmaIndex = adcChannelCount;
        adcConfig[ADC_CHANNEL0].sampleTime = ((uint8_t)0x07);
        adcConfig[ADC_CHANNEL0].enabled = 
# 58 "./src/main/drivers/adc_stm32f30x.c" 3 4
                                         1
# 58 "./src/main/drivers/adc_stm32f30x.c"
                                             ;
        adcChannelCount++;
    }
    ...
    if (init->channelMask & ADC_CHANNEL1_ENABLE) {
        ...
        adcConfig[ADC_CHANNEL1].adcChannel = ((uint8_t)0x02);
        adcConfig[ADC_CHANNEL1].dmaIndex = adcChannelCount;
        adcConfig[ADC_CHANNEL1].sampleTime = ((uint8_t)0x07);
        adcConfig[ADC_CHANNEL1].enabled = 
# 71 "./src/main/drivers/adc_stm32f30x.c" 3 4
                                         1
# 71 "./src/main/drivers/adc_stm32f30x.c"
                                             ;
        adcChannelCount++;
    }
    ...
    if (init->channelMask & ADC_CHANNEL2_ENABLE) {
        ...
        adcConfig[ADC_CHANNEL2].adcChannel = ((uint8_t)0x0C);
        adcConfig[ADC_CHANNEL2].dmaIndex = adcChannelCount;
        adcConfig[ADC_CHANNEL2].sampleTime = ((uint8_t)0x07);
        adcConfig[ADC_CHANNEL2].enabled = 
# 84 "./src/main/drivers/adc_stm32f30x.c" 3 4
                                         1
# 84 "./src/main/drivers/adc_stm32f30x.c"
                                             ;
        adcChannelCount++;
    }
# 128 "./src/main/drivers/adc_stm32f30x.c"
