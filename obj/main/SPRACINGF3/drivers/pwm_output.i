...
static 
# 55 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 55 "./src/main/drivers/pwm_output.c"
           pwmMotorsEnabled = 
# 55 "./src/main/drivers/pwm_output.c" 3 4
                              1
# 55 "./src/main/drivers/pwm_output.c"
...
{
    pwmMotorsEnabled = 
# 161 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 161 "./src/main/drivers/pwm_output.c"
                           ;
}
...
{
    uint8_t index;
    TIM_TypeDef *lastTimerPtr = 
# 172 "./src/main/drivers/pwm_output.c" 3 4
                               ((void *)0)
# 172 "./src/main/drivers/pwm_output.c"
                                   ;
...
# 189 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 189 "./src/main/drivers/pwm_output.c"
    isMotorBrushed(uint16_t motorPwmRate)
{
