...
# 63 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                          ((void *)0)
# 63 "./src/main/drivers/bus_i2c_stm32f30x.c"
                              ;
...
static 
# 69 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
      _Bool 
# 69 "./src/main/drivers/bus_i2c_stm32f30x.c"
           i2cOverClock;

void i2cSetOverclock(uint8_t OverClock)
{
    i2cOverClock = (OverClock) ? 
# 73 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                                1 
# 73 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                     : 
# 73 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                                       0
# 73 "./src/main/drivers/bus_i2c_stm32f30x.c"
...
uint32_t i2cTimeoutUserCallback(I2C_TypeDef *I2Cx)
{
    ...
    return 
# 83 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          0
# 83 "./src/main/drivers/bus_i2c_stm32f30x.c"
               ;
}
...
# 211 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 211 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cWrite(uint8_t addr_, uint8_t reg, uint8_t data)
{
    addr_ <<= 1;
    ...
    return 
# 271 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          1
# 271 "./src/main/drivers/bus_i2c_stm32f30x.c"
              ;
}


# 274 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 274 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cRead(uint8_t addr_, uint8_t reg, uint8_t len, uint8_t* buf)
{
    addr_ <<= 1;
...
if(reg != 0xff)
{
    ...
    return 
# 347 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          1
# 347 "./src/main/drivers/bus_i2c_stm32f30x.c"
              ;
}
