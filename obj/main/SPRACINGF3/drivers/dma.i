...
# 149 "/opt/gcc-arm-none-eabi-5_4-2016q3/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 3 4
...
dmaChannel_t dmaChannels[] = {
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000008)), .handler = 
# 43 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 43 "./src/main/drivers/dma.c"
   , .flagsShift = 0, .irqn = DMA1_Channel1_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000001C)), .handler = 
# 44 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 44 "./src/main/drivers/dma.c"
   , .flagsShift = 4, .irqn = DMA1_Channel2_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000030)), .handler = 
# 45 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 45 "./src/main/drivers/dma.c"
   , .flagsShift = 8, .irqn = DMA1_Channel3_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000044)), .handler = 
# 46 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 46 "./src/main/drivers/dma.c"
   , .flagsShift = 12, .irqn = DMA1_Channel4_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000058)), .handler = 
# 47 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 47 "./src/main/drivers/dma.c"
   , .flagsShift = 16, .irqn = DMA1_Channel5_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000006C)), .handler = 
# 48 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 48 "./src/main/drivers/dma.c"
   , .flagsShift = 20, .irqn = DMA1_Channel6_IRQn, .rcc = ((uint32_t)0x00000001)},
    {.dma = ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000)), .channel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000080)), .handler = 
# 49 "./src/main/drivers/dma.c" 3 4
   ((void *)0)
# 49 "./src/main/drivers/dma.c"
   , .flagsShift = 24, .irqn = DMA1_Channel7_IRQn, .rcc = ((uint32_t)0x00000001)},
...
void dmaHandlerInit(dmaCallbackHandler_t* handlerRec, dmaCallbackHandlerFunc* handler)
{
    ...
    handlerRec->next = 
# 97 "./src/main/drivers/dma.c" 3 4
                      ((void *)0)
# 97 "./src/main/drivers/dma.c"
                          ;
}
