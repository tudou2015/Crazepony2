...
# 235 "./src/main/drivers/bus_spi.c"
...
# 274 "./src/main/drivers/bus_spi.c"
    ...
    spi.SPI_CPOL = ((uint16_t)0x0000);
    spi.SPI_CPHA = ((uint16_t)0x0000);
...
# 428 "./src/main/drivers/bus_spi.c"

# 428 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 428 "./src/main/drivers/bus_spi.c"
    spiInit(SPI_TypeDef *instance)
{
    ...
    (void)(instance);
# 441 "./src/main/drivers/bus_spi.c"
    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800))) {
        initSpi2();
        return 
# 443 "./src/main/drivers/bus_spi.c" 3 4
              1
# 443 "./src/main/drivers/bus_spi.c"
                  ;
    }
    ...
    return 
# 452 "./src/main/drivers/bus_spi.c" 3 4
          0
# 452 "./src/main/drivers/bus_spi.c"
               ;
}
...
# 487 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 487 "./src/main/drivers/bus_spi.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
