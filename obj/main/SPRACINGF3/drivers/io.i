...
# 115 "./src/main/drivers/io.c" 3 4
_Bool 
# 115 "./src/main/drivers/io.c"
    IORead(IO_t io)
{
    if(!io)
        return 
# 118 "./src/main/drivers/io.c" 3 4
              0
# 118 "./src/main/drivers/io.c"
                   ;
    return !!(IO_GPIO(io)->IDR & IO_Pin(io));
}

void IOWrite(IO_t io, 
# 122 "./src/main/drivers/io.c" 3 4
                     _Bool 
# 122 "./src/main/drivers/io.c"
                          hi)
{
    if(!io)
        return;
...
static const uint16_t ioDefUsedMask[6] = {0xffff,0xffff,((1 << (13))|(1 << (14))|(1 << (15))),0,0,((1 << (0))|(1 << (1)))};
...
IO_t IOGetByTag(ioTag_t tag)
{
    ...
    if(portIdx >= 6)
        return 
# 262 "./src/main/drivers/io.c" 3 4
              ((void *)0)
# 262 "./src/main/drivers/io.c"
                  ;

    if(!(ioDefUsedMask[portIdx] & (1 << pinIdx)))
        return 
# 265 "./src/main/drivers/io.c" 3 4
              ((void *)0)
# 265 "./src/main/drivers/io.c"
                  ;
