...
# 44 "./src/main/drivers/serial_uart.c" 2


void usartInitAllIOSignals(void)
{
# 76 "./src/main/drivers/serial_uart.c"
    gpio_config_t gpio;
...
# 104 "./src/main/drivers/serial_uart.c" 3 4
   _Bool 
# 104 "./src/main/drivers/serial_uart.c"
        inverted = uartPort->port.options & SERIAL_INVERTED;
# 114 "./src/main/drivers/serial_uart.c"
...
{
    uartPort_t *s = 
# 160 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 160 "./src/main/drivers/serial_uart.c"
                       ;
...
# 180 "./src/main/drivers/serial_uart.c"
    ...
    s->txDMAEmpty = 
# 183 "./src/main/drivers/serial_uart.c" 3 4
                   1
# 183 "./src/main/drivers/serial_uart.c"
                       ;
...
# 337 "./src/main/drivers/serial_uart.c" 3 4
_Bool 
# 337 "./src/main/drivers/serial_uart.c"
    isUartTransmitBufferEmpty(serialPort_t *instance)
{
    uartPort_t *s = (uartPort_t *)instance;
    if (s->txDMAChannel)
        return s->txDMAEmpty;
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        uartSetMode,
        .writeBuf = 
# 394 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 394 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 395 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 395 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 396 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 396 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
