...
# 45 "./src/main/drivers/compass_hmc5883l.c" 2
# 108 "./src/main/drivers/compass_hmc5883l.c"
...
static const hmc5883Config_t *hmc5883Config = 
# 124 "./src/main/drivers/compass_hmc5883l.c" 3 4
                                             ((void *)0)
# 124 "./src/main/drivers/compass_hmc5883l.c"
                                                 ;
...
{
    (void)(cb);
# 148 "./src/main/drivers/compass_hmc5883l.c"
}
...
static void hmc5883lConfigureDataReadyInterruptHandling(void)
{
    ...
    EXTIEnable(intIO, 
# 168 "./src/main/drivers/compass_hmc5883l.c" 3 4
                     1
# 168 "./src/main/drivers/compass_hmc5883l.c"
                         );

}


# 172 "./src/main/drivers/compass_hmc5883l.c" 3 4
_Bool 
# 172 "./src/main/drivers/compass_hmc5883l.c"
    hmc5883lDetect(mag_t* mag, const hmc5883Config_t *hmc5883ConfigToUse)
{
    
# 174 "./src/main/drivers/compass_hmc5883l.c" 3 4
   _Bool 
# 174 "./src/main/drivers/compass_hmc5883l.c"
        ack = 
# 174 "./src/main/drivers/compass_hmc5883l.c" 3 4
              0
# 174 "./src/main/drivers/compass_hmc5883l.c"
    ...
    if (!ack || sig != 'H')
        return 
# 181 "./src/main/drivers/compass_hmc5883l.c" 3 4
              0
# 181 "./src/main/drivers/compass_hmc5883l.c"
                   ;
    ...
    return 
# 186 "./src/main/drivers/compass_hmc5883l.c" 3 4
          1
# 186 "./src/main/drivers/compass_hmc5883l.c"
              ;
}
...
# 194 "./src/main/drivers/compass_hmc5883l.c" 3 4
   _Bool 
# 194 "./src/main/drivers/compass_hmc5883l.c"
        bret = 
# 194 "./src/main/drivers/compass_hmc5883l.c" 3 4
               1
# 194 "./src/main/drivers/compass_hmc5883l.c"
    ...
    for (i = 0; i < 10; i++) {
        ...
        if (-4096 >= ((magADC[X]) < (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))) ? (magADC[X]) : (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))))) {
            bret = 
# 235 "./src/main/drivers/compass_hmc5883l.c" 3 4
                  0
# 235 "./src/main/drivers/compass_hmc5883l.c"
                       ;
            break;
        }
        do {} while(0);
    ...
    for (i = 0; i < 10; i++) {
        ...
        if (-4096 >= ((magADC[X]) < (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))) ? (magADC[X]) : (((magADC[Y]) < (magADC[Z]) ? (magADC[Y]) : (magADC[Z]))))) {
            bret = 
# 255 "./src/main/drivers/compass_hmc5883l.c" 3 4
                  0
# 255 "./src/main/drivers/compass_hmc5883l.c"
                       ;
            break;
        }
        do {} while(0);
...
# 280 "./src/main/drivers/compass_hmc5883l.c" 3 4
_Bool 
# 280 "./src/main/drivers/compass_hmc5883l.c"
    hmc5883lRead(int16_t *magData)
{
    uint8_t buf[6];

    
# 284 "./src/main/drivers/compass_hmc5883l.c" 3 4
   _Bool 
# 284 "./src/main/drivers/compass_hmc5883l.c"
        ack = i2cRead(0x1E, 0x03, 6, buf);
    if (!ack) {
        return 
# 286 "./src/main/drivers/compass_hmc5883l.c" 3 4
              0
# 286 "./src/main/drivers/compass_hmc5883l.c"
                   ;
    }
    ...
    return 
# 294 "./src/main/drivers/compass_hmc5883l.c" 3 4
          1
# 294 "./src/main/drivers/compass_hmc5883l.c"
              ;
}
