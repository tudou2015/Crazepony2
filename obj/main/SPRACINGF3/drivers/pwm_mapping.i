...
# 1 "./src/main/drivers/serial_uart_stm32f30x.h" 1
# 18 "./src/main/drivers/serial_uart_stm32f30x.h"
       
# 49 "./src/main/drivers/serial_uart_stm32f30x.h"
...
# 40 "./src/main/drivers/pwm_mapping.c" 2
...
# 381 "./src/main/drivers/pwm_mapping.c"
...
# 673 "./src/main/drivers/pwm_mapping.c"
...
# 718 "./src/main/drivers/pwm_mapping.c"
        if (init->useUART2 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)) && (timerHardwarePtr->pin == ((uint16_t)0x4000) || timerHardwarePtr->pin == ((uint16_t)0x8000)))
            continue;
        ...
        if (init->useUART3 && timerHardwarePtr->gpio == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0400)) && (timerHardwarePtr->pin == ((uint16_t)0x0400) || timerHardwarePtr->pin == ((uint16_t)0x0800)))
            continue;
# 749 "./src/main/drivers/pwm_mapping.c"
...
# 968 "./src/main/drivers/pwm_mapping.c"
        } else {
            continue;
        }
