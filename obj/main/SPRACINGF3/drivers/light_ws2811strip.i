...
void ws2811LedStripInit(void)
{
    ...
    dmaSetHandler((&dmaChannels[1]), &ws2811DMAHandlerRec, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
    ws2811LedStripHardwareInit();
    ws2811UpdateStrip();
}


# 100 "./src/main/drivers/light_ws2811strip.c" 3 4
_Bool 
# 100 "./src/main/drivers/light_ws2811strip.c"
    isWS2811LedStripReady(void)
{
