...
# 101 "./src/main/drivers/pwm_rx.c" 3 4
   _Bool 
# 101 "./src/main/drivers/pwm_rx.c"
            tracking;
    
# 102 "./src/main/drivers/pwm_rx.c" 3 4
   _Bool 
# 102 "./src/main/drivers/pwm_rx.c"
            overflowed;
} ppmDevice_t;
...
# 116 "./src/main/drivers/pwm_rx.c" 3 4
_Bool 
# 116 "./src/main/drivers/pwm_rx.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmInit(void)
{
    ...
    ppmDev.tracking = 
# 167 "./src/main/drivers/pwm_rx.c" 3 4
                         0
# 167 "./src/main/drivers/pwm_rx.c"
                              ;
    ppmDev.overflowed = 
# 168 "./src/main/drivers/pwm_rx.c" 3 4
                         0
# 168 "./src/main/drivers/pwm_rx.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 178 "./src/main/drivers/pwm_rx.c" 3 4
                           1
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 215 "./src/main/drivers/pwm_rx.c" 3 4
                       0
# 215 "./src/main/drivers/pwm_rx.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 269 "./src/main/drivers/pwm_rx.c" 3 4
                           1
# 269 "./src/main/drivers/pwm_rx.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 284 "./src/main/drivers/pwm_rx.c" 3 4
                             0
# 284 "./src/main/drivers/pwm_rx.c"
                                  ;
            for (i = 0; i < 12; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 294 "./src/main/drivers/pwm_rx.c" 3 4
_Bool 
# 294 "./src/main/drivers/pwm_rx.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 12; channel++) {
        if (captures[channel] != 0) {
            return 
# 299 "./src/main/drivers/pwm_rx.c" 3 4
                  1
# 299 "./src/main/drivers/pwm_rx.c"
                      ;
        }
    }
    return 
# 302 "./src/main/drivers/pwm_rx.c" 3 4
          0
# 302 "./src/main/drivers/pwm_rx.c"
               ;
}
...
# 308 "./src/main/drivers/pwm_rx.c" 3 4
                                  __builtin_offsetof (
# 308 "./src/main/drivers/pwm_rx.c"
                                  pwmInputPort_t
# 308 "./src/main/drivers/pwm_rx.c" 3 4
                                  , 
# 308 "./src/main/drivers/pwm_rx.c"
...
# 318 "./src/main/drivers/pwm_rx.c" 3 4
                                  __builtin_offsetof (
# 318 "./src/main/drivers/pwm_rx.c"
                                  pwmInputPort_t
# 318 "./src/main/drivers/pwm_rx.c" 3 4
                                  , 
# 318 "./src/main/drivers/pwm_rx.c"
