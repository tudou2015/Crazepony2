...
# 6 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/math.h" 2 3
...
# 7 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/math.h" 2 3
# 1 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/machine/ieeefp.h" 1 3
# 8 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/math.h" 2 3
# 1 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/_ansi.h" 1 3
# 9 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/math.h" 2 3
...
# 120 "./src/main/drivers/gpio.h"
                                            enable);
# 34 "./src/main/drivers/compass_ak8975.c" 2
...
# 37 "./src/main/drivers/compass_ak8975.c" 2
...
# 40 "./src/main/drivers/compass_ak8975.c" 2
...
# 42 "./src/main/drivers/compass_ak8975.c" 2
...
# 63 "./src/main/drivers/compass_ak8975.c" 3 4
_Bool 
# 63 "./src/main/drivers/compass_ak8975.c"
    ak8975Detect(mag_t *mag)
{
    
# 65 "./src/main/drivers/compass_ak8975.c" 3 4
   _Bool 
# 65 "./src/main/drivers/compass_ak8975.c"
        ack = 
# 65 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 65 "./src/main/drivers/compass_ak8975.c"
    ...
    if (!ack || sig != 'H')
        return 
# 70 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 70 "./src/main/drivers/compass_ak8975.c"
                   ;
    ...
    return 
# 75 "./src/main/drivers/compass_ak8975.c" 3 4
          1
# 75 "./src/main/drivers/compass_ak8975.c"
              ;
}
...
# 84 "./src/main/drivers/compass_ak8975.c" 3 4
   _Bool 
# 84 "./src/main/drivers/compass_ak8975.c"
        ack;
    uint8_t buffer[3];
    uint8_t status;
...
# 115 "./src/main/drivers/compass_ak8975.c" 3 4
_Bool 
# 115 "./src/main/drivers/compass_ak8975.c"
    ak8975Read(int16_t *magData)
{
    
# 117 "./src/main/drivers/compass_ak8975.c" 3 4
   _Bool 
# 117 "./src/main/drivers/compass_ak8975.c"
        ack;
    (void)(ack);
    uint8_t status;
    uint8_t buf[6];
    ...
    if (!ack || (status & (1 << 0)) == 0) {
        return 
# 124 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 124 "./src/main/drivers/compass_ak8975.c"
                   ;
    }


    ack = i2cRead(0x0C, 0x03, 6, buf);
# 138 "./src/main/drivers/compass_ak8975.c"
    ack = i2cRead(0x0C, 0x09, 1, &status);
    if (!ack) {
        return 
# 140 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 140 "./src/main/drivers/compass_ak8975.c"
                   ;
    }

    if (status & (1 << 2)) {
        return 
# 144 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 144 "./src/main/drivers/compass_ak8975.c"
                   ;
    }

    if (status & (1 << 3)) {
        return 
# 148 "./src/main/drivers/compass_ak8975.c" 3 4
              0
# 148 "./src/main/drivers/compass_ak8975.c"
                   ;
    }
    ...
    ack = i2cWrite(0x0C, 0x0a, 0x01);
    return 
# 157 "./src/main/drivers/compass_ak8975.c" 3 4
          1
# 157 "./src/main/drivers/compass_ak8975.c"
              ;
}
