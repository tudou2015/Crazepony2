...
# 62 "./src/main/drivers/barometer_ms5611.c" 3 4
_Bool 
# 62 "./src/main/drivers/barometer_ms5611.c"
    ms5611Detect(baro_t *baro)
{
    
# 64 "./src/main/drivers/barometer_ms5611.c" 3 4
   _Bool 
# 64 "./src/main/drivers/barometer_ms5611.c"
        ack = 
# 64 "./src/main/drivers/barometer_ms5611.c" 3 4
              0
# 64 "./src/main/drivers/barometer_ms5611.c"
    ...
    if (!ack)
        return 
# 72 "./src/main/drivers/barometer_ms5611.c" 3 4
              0
# 72 "./src/main/drivers/barometer_ms5611.c"
                   ;
    ...
    if (ms5611_crc(ms5611_c) != 0)
        return 
# 80 "./src/main/drivers/barometer_ms5611.c" 3 4
              0
# 80 "./src/main/drivers/barometer_ms5611.c"
                   ;
    ...
    return 
# 91 "./src/main/drivers/barometer_ms5611.c" 3 4
          1
# 91 "./src/main/drivers/barometer_ms5611.c"
              ;
}
...
# 114 "./src/main/drivers/barometer_ms5611.c" 3 4
   _Bool 
# 114 "./src/main/drivers/barometer_ms5611.c"
        blankEeprom = 
# 114 "./src/main/drivers/barometer_ms5611.c" 3 4
                      1
# 114 "./src/main/drivers/barometer_ms5611.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 118 "./src/main/drivers/barometer_ms5611.c" 3 4
                         0
# 118 "./src/main/drivers/barometer_ms5611.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
