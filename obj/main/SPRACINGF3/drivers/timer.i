...
void timerChOvrHandlerInit(timerOvrHandlerRec_t *self, timerOvrHandlerCallback *fn)
{
    self->fn = fn;
    self->next = 
# 599 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 599 "./src/main/drivers/timer.c"
                    ;
}
...
static void timerChConfig_UpdateOverflow(timerConfig_t *cfg, TIM_TypeDef *tim)
{
    ...
    for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        ...
        *chain = 
# 613 "./src/main/drivers/timer.c" 3 4
                ((void *)0)
# 613 "./src/main/drivers/timer.c"
                    ;
    }
...
void timerChConfigCallbacks(const timerHardware_t *timHw, timerCCHandlerRec_t *edgeCallback, timerOvrHandlerRec_t *overflowCallback)
{
    ...
    if(edgeCallback == 
# 627 "./src/main/drivers/timer.c" 3 4
                      ((void *)0)
# 627 "./src/main/drivers/timer.c"
                          )
...
void timerChConfigCallbacksDual(const timerHardware_t *timHw, timerCCHandlerRec_t *edgeCallbackLo, timerCCHandlerRec_t *edgeCallbackHi, timerOvrHandlerRec_t *overflowCallback)
{
    ...
    if(edgeCallbackLo == 
# 652 "./src/main/drivers/timer.c" 3 4
                        ((void *)0)
# 652 "./src/main/drivers/timer.c"
                            )
        TIM_ITConfig(timHw->tim, (((uint16_t)0x0002) << ((chLo) / 4)), DISABLE);
    if(edgeCallbackHi == 
# 654 "./src/main/drivers/timer.c" 3 4
                        ((void *)0)
# 654 "./src/main/drivers/timer.c"
                            )
...
# 661 "./src/main/drivers/timer.c" 3 4
                                                                ((void *)0)
# 661 "./src/main/drivers/timer.c"
                                                                    ;
...
void timerChConfigIC(const timerHardware_t *timHw, 
# 726 "./src/main/drivers/timer.c" 3 4
                                                  _Bool 
# 726 "./src/main/drivers/timer.c"
...
void timerChConfigICDual(const timerHardware_t *timHw, 
# 742 "./src/main/drivers/timer.c" 3 4
                                                      _Bool 
# 742 "./src/main/drivers/timer.c"
                                                           polarityRising, unsigned inputFilterTicks)
{
    TIM_ICInitTypeDef TIM_ICInitStructure;
    
# 745 "./src/main/drivers/timer.c" 3 4
   _Bool 
# 745 "./src/main/drivers/timer.c"
...
void timerChICPolarity(const timerHardware_t *timHw, 
# 762 "./src/main/drivers/timer.c" 3 4
                                                    _Bool 
# 762 "./src/main/drivers/timer.c"
                                                         polarityRising)
{
...
void timerChConfigOC(const timerHardware_t* timHw, 
# 787 "./src/main/drivers/timer.c" 3 4
                                                  _Bool 
# 787 "./src/main/drivers/timer.c"
                                                       outEnable, 
# 787 "./src/main/drivers/timer.c" 3 4
                                                                  _Bool 
# 787 "./src/main/drivers/timer.c"
