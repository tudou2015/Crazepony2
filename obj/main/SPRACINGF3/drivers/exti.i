...
void EXTIRelease(IO_t io)
{
    ...
    EXTIEnable(io, 
# 105 "./src/main/drivers/exti.c" 3 4
                  0
# 105 "./src/main/drivers/exti.c"
                       );
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 112 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 112 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 115 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 115 "./src/main/drivers/exti.c"
                             enable)
{
# 126 "./src/main/drivers/exti.c"
