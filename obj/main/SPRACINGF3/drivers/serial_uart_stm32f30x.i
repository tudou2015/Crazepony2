...
# 42 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 43 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 44 "./src/main/drivers/serial_uart_stm32f30x.c" 2
# 54 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 69 "./src/main/drivers/serial_uart_stm32f30x.c"
static void handleUsartTxDma(dmaChannel_t* descriptor, dmaCallbackHandler_t* handler)
{
    uartPort_t *s = ( __extension__ ({ const typeof( ((uartPort_t *)0)->dmaTxHandler ) *__mptr = (handler); (uartPort_t *)( (char *)__mptr - 
# 71 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
                   __builtin_offsetof (
# 71 "./src/main/drivers/serial_uart_stm32f30x.c"
                   uartPort_t
# 71 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
                   , 
# 71 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 71 "./src/main/drivers/serial_uart_stm32f30x.c"
    ...
    if (s->port.txBufferHead != s->port.txBufferTail)
        ...
        s->txDMAEmpty = 
# 78 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
                       1
# 78 "./src/main/drivers/serial_uart_stm32f30x.c"
                           ;
}
...
# 184 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 219 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 260 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 295 "./src/main/drivers/serial_uart_stm32f30x.c"
