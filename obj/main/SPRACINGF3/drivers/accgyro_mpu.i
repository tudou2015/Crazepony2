...
# 29 "./src/main/drivers/accgyro_mpu3050.h" 3 4
_Bool 
# 29 "./src/main/drivers/accgyro_mpu3050.h"
    mpu3050Detect(gyro_t *gyro);
...
# 20 "./src/main/drivers/accgyro_mpu6050.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_mpu6050.h"
    mpu6050AccDetect(acc_t *acc);

# 21 "./src/main/drivers/accgyro_mpu6050.h" 3 4
_Bool 
# 21 "./src/main/drivers/accgyro_mpu6050.h"
    mpu6050GyroDetect(gyro_t *gyro);
...
# 25 "./src/main/drivers/accgyro_mpu6500.h" 3 4
_Bool 
# 25 "./src/main/drivers/accgyro_mpu6500.h"
    mpu6500AccDetect(acc_t *acc);

# 26 "./src/main/drivers/accgyro_mpu6500.h" 3 4
_Bool 
# 26 "./src/main/drivers/accgyro_mpu6500.h"
    mpu6500GyroDetect(gyro_t *gyro);
...
# 15 "./src/main/drivers/accgyro_spi_mpu6000.h" 3 4
_Bool 
# 15 "./src/main/drivers/accgyro_spi_mpu6000.h"
    mpu6000SpiDetect(void);


# 17 "./src/main/drivers/accgyro_spi_mpu6000.h" 3 4
_Bool 
# 17 "./src/main/drivers/accgyro_spi_mpu6000.h"
    mpu6000SpiAccDetect(acc_t *acc);

# 18 "./src/main/drivers/accgyro_spi_mpu6000.h" 3 4
_Bool 
# 18 "./src/main/drivers/accgyro_spi_mpu6000.h"
    mpu6000SpiGyroDetect(gyro_t *gyro);


# 20 "./src/main/drivers/accgyro_spi_mpu6000.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_spi_mpu6000.h"
    mpu6000WriteRegister(uint8_t reg, uint8_t data);

# 21 "./src/main/drivers/accgyro_spi_mpu6000.h" 3 4
_Bool 
# 21 "./src/main/drivers/accgyro_spi_mpu6000.h"
    mpu6000ReadRegister(uint8_t reg, uint8_t length, uint8_t *data);
...
# 20 "./src/main/drivers/accgyro_spi_mpu6500.h" 3 4
_Bool 
# 20 "./src/main/drivers/accgyro_spi_mpu6500.h"
    mpu6500SpiDetect(void);


# 22 "./src/main/drivers/accgyro_spi_mpu6500.h" 3 4
_Bool 
# 22 "./src/main/drivers/accgyro_spi_mpu6500.h"
    mpu6500SpiAccDetect(acc_t *acc);

# 23 "./src/main/drivers/accgyro_spi_mpu6500.h" 3 4
_Bool 
# 23 "./src/main/drivers/accgyro_spi_mpu6500.h"
    mpu6500SpiGyroDetect(gyro_t *gyro);


# 25 "./src/main/drivers/accgyro_spi_mpu6500.h" 3 4
_Bool 
# 25 "./src/main/drivers/accgyro_spi_mpu6500.h"
    mpu6500WriteRegister(uint8_t reg, uint8_t data);

# 26 "./src/main/drivers/accgyro_spi_mpu6500.h" 3 4
_Bool 
# 26 "./src/main/drivers/accgyro_spi_mpu6500.h"
    mpu6500ReadRegister(uint8_t reg, uint8_t length, uint8_t *data);
...
typedef 
# 124 "./src/main/drivers/accgyro_mpu.h" 3 4
       _Bool 
# 124 "./src/main/drivers/accgyro_mpu.h"
            (*mpuReadRegisterFunc)(uint8_t reg, uint8_t length, uint8_t* data);
typedef 
# 125 "./src/main/drivers/accgyro_mpu.h" 3 4
       _Bool 
# 125 "./src/main/drivers/accgyro_mpu.h"
            (*mpuWriteRegisterFunc)(uint8_t reg, uint8_t data);
...
# 189 "./src/main/drivers/accgyro_mpu.h" 3 4
_Bool 
# 189 "./src/main/drivers/accgyro_mpu.h"
    mpuAccRead(int16_t *accData);

# 190 "./src/main/drivers/accgyro_mpu.h" 3 4
_Bool 
# 190 "./src/main/drivers/accgyro_mpu.h"
    mpuGyroRead(int16_t *gyroADC);
mpuDetectionResult_t *detectMpu(const extiConfig_t *configToUse);

# 192 "./src/main/drivers/accgyro_mpu.h" 3 4
_Bool 
# 192 "./src/main/drivers/accgyro_mpu.h"
    mpuIsDataReady(void);
...
static 
# 49 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 49 "./src/main/drivers/accgyro_mpu.c"
           mpuReadRegisterI2C(uint8_t reg, uint8_t length, uint8_t* data);
static 
# 50 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 50 "./src/main/drivers/accgyro_mpu.c"
           mpuWriteRegisterI2C(uint8_t reg, uint8_t data);

static void mpu6050FindRevision(void);

static volatile 
# 54 "./src/main/drivers/accgyro_mpu.c" 3 4
               _Bool 
# 54 "./src/main/drivers/accgyro_mpu.c"
                    mpuDataReady;


static 
# 57 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 57 "./src/main/drivers/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(void);
...
# 63 "./src/main/drivers/accgyro_mpu.c" 3 4
                                             ((void *)0)
# 63 "./src/main/drivers/accgyro_mpu.c"
                                                 ;
...
# 74 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 74 "./src/main/drivers/accgyro_mpu.c"
        ack;
    uint8_t sig;
...
# 87 "./src/main/drivers/accgyro_mpu.c" 3 4
       _Bool 
# 87 "./src/main/drivers/accgyro_mpu.c"
            detectedSpiSensor = detectSPISensorsAndUpdateDetectionResult();
...
static 
# 120 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 120 "./src/main/drivers/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(void)
{
# 142 "./src/main/drivers/accgyro_mpu.c"
    return 
# 142 "./src/main/drivers/accgyro_mpu.c" 3 4
          0
# 142 "./src/main/drivers/accgyro_mpu.c"
               ;
}
...
# 148 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 148 "./src/main/drivers/accgyro_mpu.c"
        ack;
    (void)(ack);
...
void mpuIntExtiHandler(extiCallbackRec_t *cb)
{
    ...
    mpuDataReady = 
# 191 "./src/main/drivers/accgyro_mpu.c" 3 4
                  1
# 191 "./src/main/drivers/accgyro_mpu.c"
                      ;
# 206 "./src/main/drivers/accgyro_mpu.c"
}
...
void configureMPUDataReadyInterruptHandling(void)
{
    ...
    EXTIEnable(mpuIntIO, 
# 222 "./src/main/drivers/accgyro_mpu.c" 3 4
                        1
# 222 "./src/main/drivers/accgyro_mpu.c"
                            );
...
void mpuIntExtiInit(void)
{
    ...
    static 
# 230 "./src/main/drivers/accgyro_mpu.c" 3 4
          _Bool 
# 230 "./src/main/drivers/accgyro_mpu.c"
               mpuExtiInitDone = 
# 230 "./src/main/drivers/accgyro_mpu.c" 3 4
                                 0
# 230 "./src/main/drivers/accgyro_mpu.c"
    ...
    mpuExtiInitDone = 
# 254 "./src/main/drivers/accgyro_mpu.c" 3 4
                     1
# 254 "./src/main/drivers/accgyro_mpu.c"
                         ;
}

static 
# 257 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 257 "./src/main/drivers/accgyro_mpu.c"
           mpuReadRegisterI2C(uint8_t reg, uint8_t length, uint8_t* data)
{
    
# 259 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 259 "./src/main/drivers/accgyro_mpu.c"
        ack = i2cRead(0x68, reg, length, data);
    return ack;
}

static 
# 263 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 263 "./src/main/drivers/accgyro_mpu.c"
           mpuWriteRegisterI2C(uint8_t reg, uint8_t data)
{
    
# 265 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 265 "./src/main/drivers/accgyro_mpu.c"
        ack = i2cWrite(0x68, reg, data);
    return ack;
}


# 269 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 269 "./src/main/drivers/accgyro_mpu.c"
    mpuAccRead(int16_t *accData)
{
    uint8_t data[6];

    
# 273 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 273 "./src/main/drivers/accgyro_mpu.c"
        ack = mpuConfiguration.read(0x3B, 6, data);
    if (!ack) {
        return 
# 275 "./src/main/drivers/accgyro_mpu.c" 3 4
              0
# 275 "./src/main/drivers/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 282 "./src/main/drivers/accgyro_mpu.c" 3 4
          1
# 282 "./src/main/drivers/accgyro_mpu.c"
              ;
}


# 285 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 285 "./src/main/drivers/accgyro_mpu.c"
    mpuGyroRead(int16_t *gyroADC)
{
    uint8_t data[6];

    
# 289 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 289 "./src/main/drivers/accgyro_mpu.c"
        ack = mpuConfiguration.read(mpuConfiguration.gyroReadXRegister, 6, data);
    if (!ack) {
        return 
# 291 "./src/main/drivers/accgyro_mpu.c" 3 4
              0
# 291 "./src/main/drivers/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 298 "./src/main/drivers/accgyro_mpu.c" 3 4
          1
# 298 "./src/main/drivers/accgyro_mpu.c"
              ;
}


# 301 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 301 "./src/main/drivers/accgyro_mpu.c"
    mpuIsDataReady(void)
{
    if (mpuDataReady) {
        mpuDataReady = 
# 304 "./src/main/drivers/accgyro_mpu.c" 3 4
                      0
# 304 "./src/main/drivers/accgyro_mpu.c"
                           ;
        return 
# 305 "./src/main/drivers/accgyro_mpu.c" 3 4
              1
# 305 "./src/main/drivers/accgyro_mpu.c"
                  ;
    }

    return 
# 308 "./src/main/drivers/accgyro_mpu.c" 3 4
          0
# 308 "./src/main/drivers/accgyro_mpu.c"
               ;
}
