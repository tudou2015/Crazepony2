...
# 73 "./src/main/drivers/system_stm32f30x.c" 3 4
_Bool 
# 73 "./src/main/drivers/system_stm32f30x.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 76 "./src/main/drivers/system_stm32f30x.c" 3 4
              1
# 76 "./src/main/drivers/system_stm32f30x.c"
                  ;
    else
        return 
