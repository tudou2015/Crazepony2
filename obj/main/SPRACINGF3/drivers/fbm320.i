...
# 59 "./src/main/drivers/fbm320.c" 2
...
# 60 "./src/main/drivers/fbm320.c" 2
...
# 61 "./src/main/drivers/fbm320.c" 2
...
# 63 "./src/main/drivers/fbm320.c" 2
...
# 64 "./src/main/drivers/fbm320.c" 2
...
# 65 "./src/main/drivers/fbm320.c" 2
...
# 40 "/opt/gcc-arm-none-eabi-5_4-2016q3/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 3 4
...
# 61 "/opt/gcc-arm-none-eabi-5_4-2016q3/arm-none-eabi/include/stdio.h" 3
...
# 66 "./src/main/drivers/fbm320.c" 2
...
# 67 "./src/main/drivers/fbm320.c" 2
...
# 68 "./src/main/drivers/fbm320.c" 2
...
# 69 "./src/main/drivers/fbm320.c" 2
...
# 70 "./src/main/drivers/fbm320.c" 2
...
# 71 "./src/main/drivers/fbm320.c" 2
# 1 "./src/main/drivers/fbm320.h" 1
...
# 18 "./src/main/drivers/fbm320.h" 3 4
_Bool 
# 18 "./src/main/drivers/fbm320.h"
     calibrate_finished;
...
# 30 "./src/main/drivers/fbm320.h" 3 4
_Bool 
# 30 "./src/main/drivers/fbm320.h"
    fbm320_init(void);
...
# 72 "./src/main/drivers/fbm320.c" 2
...
{
    static int32_t FilterSamples[3];
    static uint8_t i = 0;
    static 
# 81 "./src/main/drivers/fbm320.c" 3 4
          _Bool 
# 81 "./src/main/drivers/fbm320.c"
               medianFilterReady = 
# 81 "./src/main/drivers/fbm320.c" 3 4
                                   0
# 81 "./src/main/drivers/fbm320.c"
    ...
    if (j == 3) {
        j = 0;
        medianFilterReady = 
# 86 "./src/main/drivers/fbm320.c" 3 4
                           1
# 86 "./src/main/drivers/fbm320.c"
                               ;
    }
...
{
    static int32_t barometerSamples[21];
...
# 118 "./src/main/drivers/fbm320.c" 3 4
_Bool 
# 118 "./src/main/drivers/fbm320.c"
    fbm320_init(void)
{
 uint8_t whoami = 0x00;
 i2cRead(0x6C | 0x01,0x6b,1,&whoami);
 if(whoami == 0x42) {
  read_offset();
  start_temperature();
  delay(3);
  ...
  FB.Reff_P = FB.RP;
  FB.calibrate_finished = 
# 132 "./src/main/drivers/fbm320.c" 3 4
                         1
# 132 "./src/main/drivers/fbm320.c"
                             ;
  return 
# 133 "./src/main/drivers/fbm320.c" 3 4
        1
# 133 "./src/main/drivers/fbm320.c"
            ;
 }
 else {
  FB.calibrate_finished = 
# 136 "./src/main/drivers/fbm320.c" 3 4
                         0
# 136 "./src/main/drivers/fbm320.c"
                              ;
  return 
# 137 "./src/main/drivers/fbm320.c" 3 4
        0
# 137 "./src/main/drivers/fbm320.c"
             ;
 }
}
...
void taskFbm320(void)
{
 ...
 switch(state) {
  ...
  case 1: FB.UT = Read_data();
    start_pressure();
    calculate_real_pressure(FB.UP, FB.UT);
    baroPressureSum = recalculateBarometerTotal(21, baroPressureSum, FB.RP);
    alt = Rel_Altitude(baroPressureSum/(21 -1),FB.Reff_P) * 100;
    FB.Altitude = 0.4*alt + (1-0.4)*FB.Altitude;
...
void start_temperature(void)
{
 i2cWrite(0x6C | 0x01,0xf4, 0x2e);
}


void start_pressure(void)
{
 i2cWrite(0x6C | 0x01,0xf4, 0xf4);
}

uint32_t Read_data(void)
{
 uint8_t buf[3];
 i2cRead(0x6C | 0x01,0xf6,1,&buf[0]);
 i2cRead(0x6C | 0x01,0xf7,1,&buf[1]);
 i2cRead(0x6C | 0x01,0xf7,1,&buf[2]);
...
void read_offset(void)
{
 ...
 for(uint8_t i = 0;i < 9;i++) {
  i2cRead(0x6C | 0x01,(0xaa+i*2),1,&buf[0]);
  i2cRead(0x6C | 0x01,(0xab+i*2),1,&buf[1]);
  R[i] = ((uint8_t) buf[0] << 8) | buf[1];
 }
 i2cRead(0x6C | 0x01,0xa4,1,&buf[0]);
 i2cRead(0x6C | 0x01,0xf1,1,&buf[1]);
